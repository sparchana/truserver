...
alter table jobpost add column jobrecruiterid bigint signed not null;
...
alter table jobpost drop foreign key fk_recruiterprofile_reccompany;
drop index ix_recruiterprofile_reccompany on jobpost;