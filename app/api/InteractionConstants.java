...
public class InteractionConstants {
    ...
    public static final String INTERACTION_RESULT_EMPLOYEE_BULK_UPLOAD_VIA_RECRUITER = "Recruiter Bulk Upload Employee/Partner";
    ...
    public static final String INTERACTION_RESULT_CANDIDATE_INTERVIEW_SCHEDULED = "Candidate interview scheduled for job_post_id-";
