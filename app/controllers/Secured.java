...
public class Secured extends Security.Authenticator {
    ...
    public String getUsername(Context ctx) {
        ...
        if(sessionId != null){
            ...
            if(developer != null && (developer.getDeveloperAccessLevel() == ServerConstants.DEV_ACCESS_LEVEL_SUPPORT_ROLE ||  developer.getDeveloperAccessLevel() == ServerConstants.DEV_ACCESS_LEVEL_SUPER_ADMIN)) {
