...
public class Interaction extends Model {
    ...
    public Interaction(String objectAUUId, int objectAType, int interactionType, String note, String result, String createdBy, int channel){
        ...
        this.result = result;
        this.createdBy = (createdBy == null) ? InteractionConstants.INTERACTION_CHANNEL_MAP.get(channel) == null ?
                InteractionConstants.INTERACTION_NOTE_CREATED_BY_ERROR: InteractionConstants.INTERACTION_CHANNEL_MAP.get(channel) : createdBy;
        this.creationTimestamp = new Timestamp(System.currentTimeMillis());
