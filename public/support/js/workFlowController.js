...
$(function () {
    ...
    app.populateJobPostCardUI = function (returnedData) {
        ...
        if(Object.keys(returnedData.interviewDetailsList).length > 0){
            jobPostInterviewAddress = "Interview Address : " + returnedData.interviewDetailsList[0].interviewFullAddress;
        } else {
            if(returnedData.jobPostAddress != null && returnedData.jobPostAddress != ""){
                jobPostInterviewAddress = "Interview Address : " + jobPost.jobPost.jobPostAddress;
            } else {
                jobPostInterviewAddress = "Interview Address : Not available";
            }
        }
