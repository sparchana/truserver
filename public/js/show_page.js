            ...
            try {
                returnedData.forEach(function (jobPost) {
                    ...
                    if (count) {
                        ...
                        $("#jobRoleTitle").html("Register for "+jobPost.jobPostTitle+" jobs");
                        $("#applyToJobsTitle").html("Apply to "+jobPost.jobPostTitle+" jobs");
                        $("#registerBtnSubmit").html("Register for "+jobPost.jobPostTitle+" jobs");
