...
function processDataForHotJobPost(returnedData) {
    ...
    if (returnedData != "Error" && returnedData != ""){
        ...
        //Company Details
        if (returnedData != null && returnedData != 0) {
            $(".posted_jobs_company_details").show();
            $("#aboutCompanyTitle").show();

            if (returnedData.company.companyLocality != null && returnedData.company.companyLocality != "") {
                $("#postedJobCompanyLocation").html(returnedData.company.companyLocality.localityName);
            }
            if (returnedData.company.companyLogo != null && returnedData.company.companyLogo != "") {
            ...
            if (returnedData.company.compType != null && returnedData.company.compType != "") {
