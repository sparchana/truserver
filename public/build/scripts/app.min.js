...
function processDataRecruiter(e){console.log("returedData :"+e.status),$("#form_recruiter").hide(),$("#thanksMsgRecruiter").show(),$("#errorMsgRecruiter").hide()}$(function(){$("#form_recruiter").submit(function(e){e.preventDefault();try{var a=$("#leadName").val(),r=$("#leadMobile").val(),t=$("#leadChannel").val(),l=$("#leadType").val(),o=$("#leadInterest").val();console.log("phone: "+r);var c={leadName:a,leadMobile:r,leadChannel:t,leadType:l,leadInterest:o};$.ajax({type:"POST",url:"/addLead",data:c,success:processDataRecruiter})}catch(n){console.log("exception occured!!"+n)}})});
