jQuery.noConflict(),jQuery(document).ready(function(o){o("[data-anchor]").click(function(){var t=o(o(this).data("anchor"));t.length&&o("html, body").animate({scrollTop:t.offset().top},1e3)})});
function processDataRecruiter(e){console.log("returedData :"+e.status),$("#form_recruiter").hide(),$("#thanksMsgRecruiter").show(),$("#errorMsgRecruiter").hide()}$(function(){$("#form_recruiter").submit(function(e){e.preventDefault();var a=$("#leadMobile").val(),r=validateMobile(a);if(0==r)alert("Enter a valid mobile number");else if(1==r)alert("Enter 10 digit mobile number");else try{var t=$("#leadName").val(),l=$("#leadChannel").val(),o=$("#leadType").val(),i=$("#leadInterest").val();console.log("phone: "+a);var n={leadName:t,leadMobile:a,leadChannel:l,leadType:o,leadInterest:i};$.ajax({type:"POST",url:"/addLead",contentType:"application/json; charset=utf-8",data:JSON.stringify(n),success:processDataRecruiter})}catch(c){console.log("exception occured!!"+c)}})});
$(document).ready(function(){try{$.ajax({type:"POST",url:"/getAllHotJobPosts",data:!1,contentType:!1,processData:!1,success:processDataAllJobPosts})}catch(o){console.log("exception occured!!"+o)}});
function processDataCheckAllJobRoles(e){var o=Object.keys(e).length;if(o>0){for(var t=Math.floor(o/4),a=o%4,n=0,l=0;l<t;l++)setJobRoles(e,n),n+=4;a>0&&(n=o-a,setJobRoles(e,n))}}function setJobRoles(e,o){var t=0,a=$("#jobRoleGrid");e.forEach(function(e){if(t>=o&&t<o+4){var n=document.createElement("div");n.className="row",a.append(n);var l=document.createElement("div");n.className="col-md-3 col-sm-4 col-xs-6",n.style="padding: 0px",n.appendChild(l);var c=document.createElement("a");c.onclick=function(){window.location.href="/job/"+e.jobName.split("/").join("_")+"_jobs/"+e.jobRoleId},l.appendChild(c);var s=document.createElement("div");s.id="jobRole",s.style="padding-top: 20%; padding-bottom: 20%",c.appendChild(s);var d=document.createElement("img");d.src="/assets/common/img/icons/"+e.jobRoleId+".svg",d.setAttribute("width","50px"),d.setAttribute("alt",e.jobName),s.appendChild(d);var i=document.createElement("div");i.id="jobRoleName",i.style="margin-top: 6px; color: #003557;",i.textContent=e.jobName,s.appendChild(i)}if(t++,t>o+4)return!0})}$(document).ready(function(){try{$.ajax({type:"POST",url:"/getAllJobsRolesWithJobs",data:!1,contentType:!1,processData:!1,success:processDataCheckAllJobRoles})}catch(e){console.log("exception occured!!"+e)}});
$(document).ready(function(){try{$.ajax({type:"POST",url:"/getAllNormalJobPosts",data:!1,contentType:!1,processData:!1,success:processDataAllJobPosts})}catch(o){console.log("exception occured!!"+o)}});
function processDataApplyJob(e){if($("#messagePromptModal").modal("show"),$("#jobApplyConfirm").modal("hide"),1==e.status){postToGoogle(),$("#customMsgIcon").attr("src","/assets/common/img/jobApplied.png"),$("#customMsg").html("Your Job Application is Successful");try{$("#apply_btn_"+applyJobId).addClass("appliedBtn").removeClass("btn-primary").prop("disabled",!0).html("Already Applied"),$("#applyBtnDiv_"+applyJobId).prop("disabled",!0)}catch(a){console.log(a)}}else 2==e.status?($("#customMsgIcon").attr("src","/assets/common/img/jobApplied.png"),$("#customMsg").html("Oops! Something went Wrong. Unable to apply")):3==e.status?($("#customMsgIcon").attr("src","/assets/common/img/alreadyApplied.png"),$("#customMsg").html("Looks like you already applied for this Job. Click My Jobs to view your applied Jobs")):4==e.status?($("#customMsgIcon").attr("src","/assets/common/img/logo.gif"),$("#customMsg").html("Oops! Candidate does't Exists")):($("#customMsgIcon").attr("src","/assets/common/img/logo.gif"),$("#customMsg").html("Oops! Looks like the job is no longer available"))}function applyJob(e,a){$("#applyButton").addClass("appliedBtn").removeClass("jobApplyBtnModal").prop("disabled",!0).html("Applying"),applyJobFlag=1,applyJobId=e;var t=localStorage.getItem("mobile");if(null==t)$("#jobApplyConfirm").modal("hide"),openLogin(),$("#myLoginModal").modal("show"),$("#signInPopup").html("Sign In to Apply");else try{var o={jobId:e,candidateMobile:t,localityId:a};$.ajax({type:"POST",url:"/applyJob",async:!1,contentType:"application/json; charset=utf-8",data:JSON.stringify(o),success:processDataApplyJob})}catch(n){console.log("exception occured!!"+n)}}function postToGoogle(){try{$.ajax({type:"GET",url:"/getJobApplicationDetailsForGoogleSheet/"+applyJobId,data:!1,async:!1,contentType:!1,processData:!1,success:processDataGetJobGoogleSheetDetails})}catch(e){console.log("exception occured!!"+e)}}function processDataGetJobGoogleSheetDetails(e){null!=e.candidateGender&&(candidateGender=0==e.candidateGender?"Male":"Female"),null!=e.candidateIsEmployed&&(isEmployed=0==e.candidateIsEmployed?"No":"Yes"),null!=e.candidateIsAssessed&&(isAssessed=0==e.candidateIsAssessed?"No":"Yes");var a=e.candidateCreationTimestamp,t=new Date(a).toLocaleDateString()+" "+new Date(a).getHours()+":"+new Date(a).getMinutes()+":"+new Date(a).getSeconds();a=e.candidateExpiryDate;var o;o=null!=a?new Date(a).toLocaleDateString():"-";var n=e.formUrl,l="",s=e.candidateTotalExp;null==s&&void 0==s||(l=getInYearMonthFormat(s));try{$.ajax({url:n,data:{"entry.1388755113":applyJobId,"entry.1115234203":null!=e.companyName?e.companyName:"","entry.1422779518":null!=e.jobRoleName?e.jobRoleName:"","entry.942294281":null!=e.candidateLeadId?e.candidateLeadId:"","entry.1345077393":null!=e.candidateName?e.candidateName:"","entry.1859090779":null!=e.candidateMobile?e.candidateMobile:"","entry.2079461892":candidateGender,"entry.2071290015":l,"entry.179139422":isEmployed,"entry.1488146275":isAssessed,"entry.67497584":null!=e.languageKnown?e.languageKnown:"","entry.441069988":null!=e.candidateMotherTongue?e.candidateMotherTongue:"","entry.1350761294":null!=e.candidateHomeLocality?e.candidateHomeLocality:"","entry.2057814300":null!=e.candidateLocalityPref?e.candidateLocalityPref:"","entry.598773915":null!=e.candidateJobPref?e.candidateJobPref:"","entry.125850326":null!=e.candidateCurrentSalary?e.candidateCurrentSalary:"","entry.240702722":null!=e.candidateEducation?e.candidateEducation:"","entry.190053755":null!=e.candidateSkill?e.candidateSkill:"","entry.971982828":t,"entry.98308337":prefLocationName,"entry.46689276":e.candidateProfileStatus,"entry.1180627971":o,"entry.791725694":e.candidateAge,"entry.528024717":e.jobApplicationChannel,"entry.1165618058":e.jobPostIsHot},type:"POST",dataType:"xml"})}catch(d){console.log("exception occured!!"+d)}}function getInYearMonthFormat(e){if(null==e)return"-";var a=Math.round(parseInt(e)/12*100)/100;return a}var companyName,candidateId,candidateGender,isEmployed,isAssessed,salary,education,homeLocality;
...
function getLocality(){return localityArray}function getJob(){return jobArray}function processDataCheckLocality(e){e.forEach(function(e){var t=e.localityId,a=e.localityName,o={};o.id=t,o.name=a,localityArray.push(o)})}function processDataCheckJobs(e){e.forEach(function(e){var t=e.jobRoleId,a=e.jobName,o={};o.id=t,o.name=a,jobArray.push(o)})}function processDataCheckCompanyLogo(e){var t=Object.keys(e).length,a=Math.floor(t/3),o=t%3,n=0,c=0,i=$("#hiringCompanies"),l=document.createElement("div");l.className="item active",i.append(l),e.forEach(function(e){if(n>=c&&n<c+3){var t=document.createElement("div");t.className="col-sm-4",l.appendChild(t);var a=document.createElement("img");a.className="img-responsive",a.id="companyLogoSlider",a.setAttribute("alt","Companies Hiring"),a.src=e.companyLogo,t.appendChild(a)}if(n++,n>3)return!0});for(var d=3,r=1;r<a;r++)setCompanyLogos(e,d),d+=3;o>0&&(d=t-o,setCompanyLogos(e,d))}function setCompanyLogos(e,t){var a=0,o=$("#hiringCompanies"),n=document.createElement("div");n.className="item",o.append(n),e.forEach(function(e){if(a>=t&&a<t+3){var o=document.createElement("div");o.className="col-sm-4",n.appendChild(o);var c=document.createElement("img");c.className="img-responsive",c.id="companyLogoSlider",c.setAttribute("alt","Companies Hiring"),c.src=e.companyLogo,o.appendChild(c)}if(a++,a>t+3)return!0})}function processDataAllJobPosts(e){var t=Object.keys(e).length;if(t>0){var a=0,o=$("#hotJobs");e.reverse(),e.forEach(function(e){if(a++,a){var t=e.jobPostToLocalityList,n="",c="",i=0;t.forEach(function(e){if(i++,i>2)return!1;var a=e.locality.localityName;n+=a,i<Object.keys(t).length&&(n+=", ")}),i=0,t.forEach(function(e){i++;var a=e.locality.localityName;c+=a,i<Object.keys(t).length&&(c+=", ")});var l=document.createElement("div");l.id="hotJobItem",o.append(l);var d=document.createElement("center");l.appendChild(d);var r=document.createElement("div");r.className="row",d.appendChild(r);var s=document.createElement("div");s.className="col-sm-2",r.appendChild(s);var m=document.createElement("img");m.src=e.company.companyLogo,m.setAttribute("width","80%"),m.id="jobLogo",s.appendChild(m);var p=document.createElement("div");p.className="col-sm-8",p.id="jobBody",r.appendChild(p);var h=document.createElement("h4");h.textContent=e.jobPostTitle+" | "+e.company.companyName,p.appendChild(h);var u=document.createElement("hr");p.appendChild(u);var g=document.createElement("div");g.className="row",g.id="jobBodyDetails",p.appendChild(g);var v=document.createElement("div");v.className="col-sm-4",v.id="jobSalary",g.appendChild(v);var y=document.createElement("div");y.className="row",v.appendChild(y);var f=document.createElement("div");f.className="col-sm-12",y.appendChild(f);var b=document.createElement("div");b.style="display : inline-block; margin: 4px;top:0",f.appendChild(b);var C=document.createElement("img");C.src="/assets/common/img/salary.svg",C.setAttribute("height","15px"),C.style="margin-top: -4px",b.appendChild(C);var E=document.createElement("div");E.style="display: inline-block; font-size: 14px","0"==e.jobPostMaxSalary?E.textContent=e.jobPostMinSalary+" monthly":E.textContent=e.jobPostMinSalary+" - "+e.jobPostMaxSalary+" monthly",f.appendChild(E);var x=document.createElement("div");x.className="col-sm-3",x.id="jobExp",g.appendChild(x);var L=document.createElement("div");L.className="row",x.appendChild(L);var j=document.createElement("div");j.className="col-sm-12",L.appendChild(j);var w=document.createElement("div");w.style="display : inline-block; margin: 4px;top:0",j.appendChild(w);var N=document.createElement("img");N.src="/assets/common/img/workExp.svg",N.setAttribute("height","15px"),N.style="margin-top: -4px",w.appendChild(N);var k=document.createElement("div");k.style="display: inline-block; font-size: 14px",k.textContent="Exp: "+e.jobPostExperience.experienceType,j.appendChild(k);var P=document.createElement("div");P.className="col-sm-5",P.id="jobLocation",g.appendChild(P);var M=document.createElement("div");M.className="row",P.appendChild(M);var A=document.createElement("div");A.className="col-sm-12",M.appendChild(A);var S=document.createElement("div");S.style="display : inline-block; margin: 4px;top:0",A.appendChild(S);var T=document.createElement("img");T.src="/assets/common/img/location.svg",T.setAttribute("height","15px"),T.style="margin-top: -4px",S.appendChild(T);var _=document.createElement("div");if(_.style="display: inline-block; font-size: 14px",_.textContent=n,A.appendChild(_),t.length-2>0){var I=document.createElement("a");I.id="locationMsg_"+e.jobPostId,I.title=c,I.style="color: #2980b9",I.textContent=" more",A.appendChild(I)}$("#locationMsg_"+e.jobPostId).attr("data-toggle","tooltip"),$(function(){$('[data-toggle="tooltip"]').tooltip()});var O=document.createElement("div");O.className="col-sm-2",r.appendChild(O);var B=document.createElement("div");B.className="jobApplyBtn",B.textContent="View Job",O.appendChild(B),B.onclick=function(){var t=e.jobPostTitle.replace("/","-");try{window.location.href="/jobs/"+t+"/Bengaluru/"+e.company.companyName+"/"+e.jobPostId}catch(a){console.log("exception occured!!"+a)}}}})}}function processCheckLeadStatus(){$("#addLeadMobile").val(""),$("#messagePromptModal").modal("show"),$("#customMsg").html("Thanks! We will get back soon!")}function addLead(){var e=$("#addLeadMobile").val(),t=validateMobile(e);if(0==t)alert("Enter a valid mobile number");else if(1==t)alert("Enter 10 digit mobile number");else try{var a={leadName:"",leadMobile:$("#addLeadMobile").val(),leadChannel:0,leadType:1,leadInterest:"General Registration"};$.ajax({type:"POST",url:"/addLead",contentType:"application/json; charset=utf-8",data:JSON.stringify(a),success:processCheckLeadStatus})}catch(o){console.log("exception occured!!"+o)}}function openLogin(){$("#signInPopup").html("Sign In"),document.getElementById("resetCheckUserBtn").disabled=!1,document.getElementById("resetNewPasswordBtn").disabled=!1,$("#form_login_candidate").show(),$("#noUserLogin").hide(),$("#incorrectMsgLogin").hide(),$("#form_forgot_password").hide(),$("#errorMsgReset").hide(),$("#form_password_reset_otp").hide(),$("#form_password_reset_new").hide()}function openSignUp(){$("#myLoginModal").modal("hide")}function resetPassword(){$("#noUserLogin").hide(),$("#incorrectMsgLogin").hide(),$("#form_login_candidate").hide(),$("#form_forgot_password").show()}var localityArray=[],jobArray=[],prefLocation,prefLocationName;$(function(){$('a[href*="#"]:not([href="#"])').click(function(){if(location.pathname.replace(/^\//,"")==this.pathname.replace(/^\//,"")&&location.hostname==this.hostname){var e=$(this.hash);e=e.length?e:$("[name="+this.hash.slice(1)+"]"),e.length&&$("html, body").animate({scrollTop:e.offset().top-92},1e3)}})}),$(function(){$("#myRegistrationModal").on("hidden.bs.modal",function(){document.getElementById("registerBtn").disabled=!1,window.location="/"})}),$(window).load(function(){$("html, body").css({overflow:"auto",height:"auto"}),$("#status").fadeOut(),$("#loaderLogo").fadeOut(),$("#preloader").delay(1e3).fadeOut("slow")}),$(document).ready(function(){$(".navbar-nav li a").click(function(e){$(".navbar-collapse").collapse("hide")});var e=window.innerWidth;e<440&&$(".navbar-default").css("background-color","white"),$(window).scroll(function(){$(document).scrollTop()>150?($("#fixed-menu").css("background-color","#2980b9"),$("#fixed-menu").fadeIn(),$(".navbar-default").css("background-color","white")):($("#fixed-menu").css("background-color","rgba(0, 0, 0, 0.175)"),$("#fixed-menu").fadeOut())});try{$.ajax({type:"POST",url:"/getAllLocality",data:!1,contentType:!1,processData:!1,success:processDataCheckLocality})}catch(t){console.log("exception occured!!"+t)}try{$.ajax({type:"POST",url:"/getAllJobs",data:!1,contentType:!1,processData:!1,success:processDataCheckJobs})}catch(t){console.log("exception occured!!"+t)}try{$.ajax({type:"POST",url:"/getAllCompanyLogos",data:!1,contentType:!1,processData:!1,success:processDataCheckCompanyLogo})}catch(t){console.log("exception occured!!"+t)}}),$(function(){$("#jobLocality").change(function(){$(this).val()!=-1?(prefLocation=$(this).val(),prefLocationName=$("#jobLocality option:selected").text(),$("#applyButton").show()):$("#applyButton").hide()})});
...
!function(t){function e(t){return String(null===t||void 0===t?"":t)}function n(t){return e(t).replace(d,function(t){return l[t]})}var a={method:"GET",queryParam:"q",searchDelay:300,minChars:1,propertyToSearch:"name",jsonContainer:null,contentType:"json",excludeCurrent:!1,excludeCurrentParameter:"x",prePopulate:null,processPrePopulate:!1,hintText:"Type in a search term",noResultsText:"No results",searchingText:"Searching...",deleteText:"&#215;",animateDropdown:!0,placeholder:null,theme:null,zindex:999,resultsLimit:null,enableHTML:!1,resultsFormatter:function(t){var e=t[this.propertyToSearch];return"<li>"+(this.enableHTML?e:n(e))+"</li>"},tokenFormatter:function(t){var e=t[this.propertyToSearch];return"<li><p>"+(this.enableHTML?e:n(e))+"</p></li>"},tokenLimit:null,tokenDelimiter:",",preventDuplicates:!1,tokenValue:"id",allowFreeTagging:!1,allowTabOut:!1,autoSelectFirstResult:!1,onResult:null,onCachedResult:null,onAdd:null,onFreeTaggingAdd:null,onDelete:null,onReady:null,idPrefix:"token-input-",disabled:!1},s={tokenList:"token-input-list",token:"token-input-token",tokenReadOnly:"token-input-token-readonly",tokenDelete:"token-input-delete-token",selectedToken:"token-input-selected-token",highlightedToken:"token-input-highlighted-token",dropdown:"token-input-dropdown",dropdownItem:"token-input-dropdown-item",dropdownItem2:"token-input-dropdown-item2",selectedDropdownItem:"token-input-selected-dropdown-item",inputToken:"token-input-input-token",focused:"token-input-focused",disabled:"token-input-disabled"},i={BEFORE:0,AFTER:1,END:2},o={BACKSPACE:8,TAB:9,ENTER:13,ESCAPE:27,SPACE:32,PAGE_UP:33,PAGE_DOWN:34,END:35,HOME:36,LEFT:37,UP:38,RIGHT:39,DOWN:40,NUMPAD_ENTER:108,COMMA:188},l={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#x27;","/":"&#x2F;"},d=/[&<>"'\/]/g,r={init:function(e,n){var s=t.extend({},a,n||{});return this.each(function(){t(this).data("settings",s),t(this).data("tokenInputObject",new t.TokenList(this,e,s))})},clear:function(){return this.data("tokenInputObject").clear(),this},add:function(t){return this.data("tokenInputObject").add(t),this},remove:function(t){return this.data("tokenInputObject").remove(t),this},get:function(){return this.data("tokenInputObject").getTokens()},toggleDisabled:function(t){return this.data("tokenInputObject").toggleDisabled(t),this},setOptions:function(e){return t(this).data("settings",t.extend({},t(this).data("settings"),e||{})),this},destroy:function(){if(this.data("tokenInputObject")){this.data("tokenInputObject").clear();var t=this,e=this.parent();return e.empty(),t.show(),e.append(t),t}}};t.fn.tokenInput=function(t){return r[t]?r[t].apply(this,Array.prototype.slice.call(arguments,1)):r.init.apply(this,arguments)},t.TokenList=function(e,a,l){function d(a){return t(e).data("settings").enableHTML?a:n(a)}function r(n){"boolean"==typeof n?t(e).data("settings").disabled=n:t(e).data("settings").disabled=!t(e).data("settings").disabled,_.attr("disabled",t(e).data("settings").disabled),q.toggleClass(t(e).data("settings").classes.disabled,t(e).data("settings").disabled),G&&k(t(G),i.END),z.attr("disabled",t(e).data("settings").disabled)}function u(){if(null!==t(e).data("settings").tokenLimit&&H>=t(e).data("settings").tokenLimit)return _.hide(),void y()}function c(){if(M!==(M=_.val())){var t=q.width()-_.offset().left-q.offset().left;Q.html(n(M)||n(l.placeholder)),_.width(Math.min(q.width(),Math.max(t,Q.width()+30)))}}function g(){var n=t.trim(_.val()),a=n.split(t(e).data("settings").tokenDelimiter);t.each(a,function(n,a){if(a){t.isFunction(t(e).data("settings").onFreeTaggingAdd)&&(a=t(e).data("settings").onFreeTaggingAdd.call(z,a));var s={};s[t(e).data("settings").tokenValue]=s[t(e).data("settings").propertyToSearch]=a,f(s)}})}function p(n){var a=t(t(e).data("settings").tokenFormatter(n)),s=n.readonly===!0;s&&a.addClass(t(e).data("settings").classes.tokenReadOnly),a.addClass(t(e).data("settings").classes.token).insertBefore(K),s||t("<span>"+t(e).data("settings").deleteText+"</span>").addClass(t(e).data("settings").classes.tokenDelete).appendTo(a).click(function(){if(!t(e).data("settings").disabled)return T(t(this).parent()),z.change(),!1});var i=n;return t.data(a.get(0),"tokeninput",n),B=B.slice(0,U).concat([i]).concat(B.slice(U)),U++,v(B,z),H+=1,null!==t(e).data("settings").tokenLimit&&H>=t(e).data("settings").tokenLimit&&(_.hide(),y()),a}function f(n){var a=t(e).data("settings").onAdd;if(H>0&&t(e).data("settings").preventDuplicates){var s=null;if(q.children().each(function(){var e=t(this),a=t.data(e.get(0),"tokeninput");if(a&&a[l.tokenValue]===n[l.tokenValue])return document.getElementsByClassName("token-input-dropdown-facebook").hide(),s=e,!1}),s)return h(s),K.insertAfter(s),void j(_)}_.width(1),(null==t(e).data("settings").tokenLimit||H<t(e).data("settings").tokenLimit)&&(p(n),_.attr("placeholder",null),u()),_.val(""),y(),t.isFunction(a)&&a.call(z,n)}function h(n){t(e).data("settings").disabled||(n.addClass(t(e).data("settings").classes.selectedToken),G=n.get(0),_.val(""),y())}function k(n,a){n.removeClass(t(e).data("settings").classes.selectedToken),G=null,a===i.BEFORE?(K.insertBefore(n),U--):a===i.AFTER?(K.insertAfter(n),U++):(K.appendTo(q),U=H),j(_)}function m(e){var n=G;G&&k(t(G),i.END),n===e.get(0)?k(e,i.END):h(e)}function T(n){var a=t.data(n.get(0),"tokeninput"),s=t(e).data("settings").onDelete,i=n.prevAll().length;i>U&&i--,n.remove(),G=null,j(_),B=B.slice(0,i).concat(B.slice(i+1)),0==B.length&&_.attr("placeholder",l.placeholder),i<U&&U--,v(B,z),H-=1,null!==t(e).data("settings").tokenLimit&&(_.show().val(""),j(_)),t.isFunction(s)&&s.call(z,a)}function v(n,a){var s=t.map(n,function(n){return"function"==typeof t(e).data("settings").tokenValue?t(e).data("settings").tokenValue.call(this,n):n[t(e).data("settings").tokenValue]});a.val(s.join(t(e).data("settings").tokenDelimiter))}function y(){$.hide().empty(),W=null}function C(){$.css({position:"absolute",top:q.offset().top+q.outerHeight(!0),left:q.offset().left,width:q.width(),"z-index":t(e).data("settings").zindex}).show()}function b(){t(e).data("settings").searchingText&&($.html("<p>"+d(t(e).data("settings").searchingText)+"</p>"),C())}function w(){t(e).data("settings").hintText&&($.html("<p>"+d(t(e).data("settings").hintText)+"</p>"),C())}function E(t){return t.replace(X,"\\$&")}function x(t,e){return t.replace(new RegExp("(?![^&;]+;)(?!<[^<>]*)("+E(e)+")(?![^<>]*>)(?![^&;]+;)","gi"),function(t,e){return"<b>"+d(e)+"</b>"})}function D(t,e,n){return t.replace(new RegExp("(?![^&;]+;)(?!<[^<>]*)("+E(e)+")(?![^<>]*>)(?![^&;]+;)","g"),x(e,n))}function R(n){if(t(e).data("settings").excludeCurrent){var a=t(e).data("tokenInputObject").getTokens(),s=[];a.length&&(t.each(n,function(n,i){var o=!0;t.each(a,function(n,a){if(i[t(e).data("settings").propertyToSearch]==a[t(e).data("settings").propertyToSearch])return o=!1,!1}),o&&s.push(i)}),n=s)}return n}function F(n,a){if(a=R(a),a&&a.length){$.empty();var s=t("<ul/>").appendTo($).mouseover(function(e){O(t(e.target).closest("li"))}).mousedown(function(e){return f(t(e.target).closest("li").data("tokeninput")),z.change(),!1}).hide();t(e).data("settings").resultsLimit&&a.length>t(e).data("settings").resultsLimit&&(a=a.slice(0,t(e).data("settings").resultsLimit)),t.each(a,function(a,i){var o=t(e).data("settings").resultsFormatter(i);o=D(o,i[t(e).data("settings").propertyToSearch],n),o=t(o).appendTo(s),a%2?o.addClass(t(e).data("settings").classes.dropdownItem):o.addClass(t(e).data("settings").classes.dropdownItem2),0===a&&t(e).data("settings").autoSelectFirstResult&&O(o),t.data(o.get(0),"tokeninput",i)}),C(),t(e).data("settings").animateDropdown?s.slideDown("fast"):s.show()}else t(e).data("settings").noResultsText&&($.html("<p>"+d(t(e).data("settings").noResultsText)+"</p>"),C())}function O(n){n&&(W&&A(t(W)),n.addClass(t(e).data("settings").classes.selectedDropdownItem),W=n.get(0))}function A(n){n.removeClass(t(e).data("settings").classes.selectedDropdownItem),W=null}function L(){var n=_.val();n&&n.length&&(G&&k(t(G),i.AFTER),n.length>=t(e).data("settings").minChars?(b(),clearTimeout(N),N=setTimeout(function(){P(n)},t(e).data("settings").searchDelay)):y())}function P(n){var a=n+S(),s=V.get(a);if(s)t.isFunction(t(e).data("settings").onCachedResult)&&(s=t(e).data("settings").onCachedResult.call(z,s)),F(n,s);else if(t(e).data("settings").url){var i=S(),o={};if(o.data={},i.indexOf("?")>-1){var d=i.split("?");o.url=d[0];var r=d[1].split("&");t.each(r,function(t,e){var n=e.split("=");o.data[n[0]]=n[1]})}else o.url=i;if(o.data[t(e).data("settings").queryParam]=n,o.type=t(e).data("settings").method,o.dataType=t(e).data("settings").contentType,t(e).data("settings").crossDomain&&(o.dataType="jsonp"),t(e).data("settings").excludeCurrent){var u=t(e).data("tokenInputObject").getTokens(),c=t.map(u,function(n){return"function"==typeof t(e).data("settings").tokenValue?t(e).data("settings").tokenValue.call(this,n):n[t(e).data("settings").tokenValue]});o.data[t(e).data("settings").excludeCurrentParameter]=c.join(t(e).data("settings").tokenDelimiter)}o.success=function(s){V.add(a,t(e).data("settings").jsonContainer?s[t(e).data("settings").jsonContainer]:s),t.isFunction(t(e).data("settings").onResult)&&(s=t(e).data("settings").onResult.call(z,s)),_.val()===n&&F(n,t(e).data("settings").jsonContainer?s[t(e).data("settings").jsonContainer]:s)},l.onSend&&l.onSend(o),t.ajax(o)}else if(t(e).data("settings").local_data){var g=t.grep(t(e).data("settings").local_data,function(a){return a[t(e).data("settings").propertyToSearch].toLowerCase().indexOf(n.toLowerCase())>-1});V.add(a,g),t.isFunction(t(e).data("settings").onResult)&&(g=t(e).data("settings").onResult.call(z,g)),F(n,g)}}function S(){var n=t(e).data("settings");return"function"==typeof n.url?n.url.call(n):n.url}function j(t){setTimeout(function(){t.focus()},50)}if("string"==typeof a||"function"==typeof a){t(e).data("settings").url=a;var I=S();void 0===t(e).data("settings").crossDomain&&"string"==typeof I&&(I.indexOf("://")===-1?t(e).data("settings").crossDomain=!1:t(e).data("settings").crossDomain=location.href.split(/\/+/g)[1]!==I.split(/\/+/g)[1])}else"object"==typeof a&&(t(e).data("settings").local_data=a);t(e).data("settings").classes?t(e).data("settings").classes=t.extend({},s,t(e).data("settings").classes):t(e).data("settings").theme?(t(e).data("settings").classes={},t.each(s,function(n,a){t(e).data("settings").classes[n]=a+"-"+t(e).data("settings").theme})):t(e).data("settings").classes=s;var N,M,B=[],H=0,V=new t.TokenList.Cache,_=t('<input type="text" autocomplete="off" autocapitalize="off"/>').css({outline:"none"}).attr("id",t(e).data("settings").idPrefix+e.id).focus(function(){l.local_data?setTimeout(function(){P("")},5):w(),q.addClass(t(e).data("settings").classes.focused)}).blur(function(){y(),t(e).data("settings").allowFreeTagging&&g(),t(this).val(""),q.removeClass(t(e).data("settings").classes.focused)}).bind("keyup keydown blur update",c).keydown(function(n){var a,s;switch(n.keyCode){case o.LEFT:case o.RIGHT:case o.UP:case o.DOWN:if(0===this.value.length)a=K.prev(),s=K.next(),a.length&&a.get(0)===G||s.length&&s.get(0)===G?n.keyCode===o.LEFT||n.keyCode===o.UP?k(t(G),i.BEFORE):k(t(G),i.AFTER):n.keyCode!==o.LEFT&&n.keyCode!==o.UP||!a.length?n.keyCode!==o.RIGHT&&n.keyCode!==o.DOWN||!s.length||h(t(s.get(0))):h(t(a.get(0)));else{var l=null;n.keyCode===o.DOWN||n.keyCode===o.RIGHT?(l=t($).find("li").first(),W&&(l=t(W).next())):(l=t($).find("li").last(),W&&(l=t(W).prev())),O(l)}break;case o.BACKSPACE:if(a=K.prev(),0===this.value.length)return G?(T(t(G)),z.change()):a.length&&h(t(a.get(0))),!1;1===t(this).val().length?y():setTimeout(function(){L()},5);break;case o.TAB:case o.ENTER:case o.NUMPAD_ENTER:case o.COMMA:if(W)f(t(W).data("tokeninput")),z.change();else{if(t(e).data("settings").allowFreeTagging){if(t(e).data("settings").allowTabOut&&""===t(this).val())return!0;g()}else if(t(this).val(""),t(e).data("settings").allowTabOut)return!0;n.stopPropagation(),n.preventDefault()}return!1;case o.ESCAPE:return y(),!0;default:String.fromCharCode(n.which)&&setTimeout(function(){L()},5)}});l.placeholder&&_.attr("placeholder",l.placeholder);var z=t(e).hide().val("").focus(function(){j(_)}).blur(function(){return _.blur(),z}),G=null,U=0,W=null,q=t("<ul />").addClass(t(e).data("settings").classes.tokenList).click(function(e){var n=t(e.target).closest("li");n&&n.get(0)&&t.data(n.get(0),"tokeninput")?m(n):(G&&k(t(G),i.END),j(_))}).mouseover(function(n){var a=t(n.target).closest("li");a&&G!==this&&a.addClass(t(e).data("settings").classes.highlightedToken)}).mouseout(function(n){var a=t(n.target).closest("li");a&&G!==this&&a.removeClass(t(e).data("settings").classes.highlightedToken)}).insertBefore(z),K=t("<li />").addClass(t(e).data("settings").classes.inputToken).appendTo(q).append(_),$=t("<div/>").addClass(t(e).data("settings").classes.dropdown).appendTo("body").hide(),Q=t("<tester/>").insertAfter(_).css({position:"absolute",top:-9999,left:-9999,width:"auto",fontSize:_.css("fontSize"),fontFamily:_.css("fontFamily"),fontWeight:_.css("fontWeight"),letterSpacing:_.css("letterSpacing"),whiteSpace:"nowrap"});z.val("");var J=t(e).data("settings").prePopulate||z.data("pre");t(e).data("settings").processPrePopulate&&t.isFunction(t(e).data("settings").onResult)&&(J=t(e).data("settings").onResult.call(z,J)),J&&J.length&&t.each(J,function(t,e){p(e),u(),_.attr("placeholder",null)}),t(e).data("settings").disabled&&r(!0),"function"==typeof t(e).data("settings").onReady&&t(e).data("settings").onReady.call(),this.clear=function(){q.children("li").each(function(){0===t(this).children("input").length&&T(t(this))})},this.add=function(t){f(t)},this.remove=function(e){q.children("li").each(function(){if(0===t(this).children("input").length){var n=t(this).data("tokeninput"),a=!0;for(var s in e)if(e[s]!==n[s]){a=!1;break}a&&T(t(this))}})},this.getTokens=function(){return B},this.toggleDisabled=function(t){r(t)},c();var X=new RegExp("[.\\\\+*?\\[\\^\\]$(){}=!<>|:\\-]","g")},t.TokenList.Cache=function(e){var n,a,s={},i=0;n=t.extend({max_size:500},e),a=function(){s={},i=0},this.add=function(t,e){i>n.max_size&&a(),s[t]||(i+=1),s[t]=e},this.get=function(t){return s[t]}}}(jQuery);
function processDataLogin(o){console.log(o),1==o.status?(localStorage.setItem("mobile","+91"+candidateMobile),localStorage.setItem("name",o.candidateFirstName),localStorage.setItem("lastName",o.candidateLastName),localStorage.setItem("assessed",o.isAssessed),localStorage.setItem("minProfile",o.minProfile),1==applyJobFlag?($("#myLoginModal").modal("hide"),applyJob(applyJobId,prefLocation),applyJobFlag=0,applyJobId=0,$("#customSubMsg").html("Logging in ..."),$("#customSubMsg").modal({backdrop:"static",keyboard:!1}),setTimeout(function(){window.location="/dashboard/appliedJobs"},3e3)):window.location="/dashboard"):3==o.status?($("#noUserLogin").show(),$("#incorrectMsgLogin").hide()):($("#noUserLogin").hide(),$("#incorrectMsgLogin").show())}var candidateMobile,applyJobFlag=0,applyJobId=0;$(function(){$("#form_login_candidate").submit(function(o){o.preventDefault();var a=$("#candidateLoginMobile").val(),e=$("#candidateLoginPassword").val();if(console.log(a+" "+e),null==a||""==a)alert("Enter your Phone Number");else if(null==e||""==e)alert("Enter your Password");else try{candidateMobile=a,console.log("phone: "+a);var t={candidateLoginMobile:a,candidateLoginPassword:e};$.ajax({type:"POST",url:"/loginSubmit",contentType:"application/json; charset=utf-8",data:JSON.stringify(t),success:processDataLogin})}catch(i){console.log("exception occured!!"+i)}})});
function getLocality(){return localityArray}function getJob(){return jobArray}function processDataCheckLocality(o){o.forEach(function(o){var t=o.localityId,a=o.localityName,e={};e.id=t,e.name=a,localityArray.push(e)})}function addLocalitiesToModal(){$("#applyButton").addClass("jobApplyBtnModal").removeClass("appliedBtn").prop("disabled",!1).html("Apply");try{$.ajax({type:"POST",url:"/getJobPostInfo/"+jobPostId+"/0",data:!1,contentType:!1,processData:!1,success:processDataForJobPostLocation})}catch(o){console.log("exception occured!!"+o)}}function processDataForJobPostLocation(o){$("#jobNameConfirmation").html(o.jobPostTitle),$("#companyNameConfirmation").html(o.company.companyName),$("#jobLocality").html("");var t=$('<option value="-1"></option>').text("Select Preferred Location");$("#jobLocality").append(t);var a=o.jobPostToLocalityList;a.forEach(function(o){var t={};t.id=o.locality.localityId,t.name=" "+o.locality.localityName,jobLocalityArray.push(t);var a=$("<option value="+o.locality.localityId+"></option>").text(o.locality.localityName);$("#jobLocality").append(a)})}function confirmApply(){applyJob(jobPostId,prefLocation)}function openLogin(){$("#signInPopup").html("Sign In"),document.getElementById("resetCheckUserBtn").disabled=!1,document.getElementById("resetNewPasswordBtn").disabled=!1,$("#form_login_candidate").show(),$("#noUserLogin").hide(),$("#incorrectMsgLogin").hide(),$("#form_forgot_password").hide(),$("#errorMsgReset").hide(),$("#form_password_reset_otp").hide(),$("#form_password_reset_new").hide()}function openSignUp(){$("#myLoginModal").modal("hide")}function resetPassword(){$("#noUserLogin").hide(),$("#incorrectMsgLogin").hide(),$("#form_login_candidate").hide(),$("#form_forgot_password").show()}function processDataCheckJobs(o){o.forEach(function(o){var t=o.jobRoleId,a=o.jobName,e={};e.id=t,e.name=a,jobArray.push(e)})}function applyJobBtnAction(){$("#jobApplyConfirm").modal(),jobPostId=jobId,jobLocalityArray=[],$("#applyButton").hide(),addLocalitiesToModal()}function processDataForHotJobPost(o){if(jobId=o.jobPostId,null!=o.jobPostTitle&&$("#postedJobTitle").html(o.jobPostTitle+" | "+o.company.companyName),null!=o.company&&($("#postedJobCompanyTitle").html(o.company.companyName),$("#postedCompanyTitle").html(o.company.companyName)),null!=o.jobPostAddress&&$("#postedJobLocationAddress").html(o.jobPostAddress),null!=o.jobPostMinSalary&&null!=o.jobPostMaxSalary&&(null==o.jobPostMaxSalary||"0"==o.jobPostMaxSalary?$("#postedJobSalary").html(o.jobPostMinSalary):null==o.jobPostMinSalary||"0"==o.jobPostMinSalary?$("#postedJobSalary").html(o.jobPostMinSalary):($("#postedJobSalary").html(o.jobPostMinSalary+" - "+o.jobPostMaxSalary),$("#salaryCondition").html("Salary (Min - Max)"))),""!=o.jobPostIncentives&&$("#postedJobIncentives").html(o.jobPostIncentives),null!=o.jobPostToLocalityList){var t=o.jobPostToLocalityList,a="";t.forEach(function(o){""!=a&&(a+=", "),a+=o.locality.localityName}),$("#postedJobLocality").html(a)}if(null!=o.jobPostShift&&$("#postedJobShift").html(o.jobPostShift.timeShiftName),""!=o.jobPostWorkingDays&&null!=o.jobPostWorkingDays){var e,n=o.jobPostWorkingDays.toString(2);if(7!=n.length){var c=7-n.length,s="";for(e=0;e<c;e++)s+="0";s+=n,n=s}var l="",i=n.split("");1!=i[0]&&(l+="Mon, "),1!=i[1]&&(l+="Tue, "),1!=i[2]&&(l+="Wed, "),1!=i[3]&&(l+="Thu, "),1!=i[4]&&(l+="Fri, "),1!=i[5]&&(l+="Sat, "),1!=i[6]&&(l+="Sun "),$("#postedJobWorkingDays").html(l+" - Holiday")}if(null!=o.jobPostStartTime&&null!=o.jobPostEndTime){var r,p;o.jobPostStartTime>12?(o.jobPostStartTime=o.jobPostStartTime-12,r="PM"):r="AM",o.jobPostEndTime>12?(o.jobPostEndTime=o.jobPostEndTime-12,p="PM"):p="AM",$("#postedJobTiming").html(o.jobPostStartTime+" "+r+" - "+o.jobPostEndTime+" "+p)}""!=o.jobPostMinRequirement&&$("#postedJobMinRequirement").html(o.jobPostMinRequirement),null!=o.jobPostExperience&&$("#postedJobExperience").html(o.jobPostExperience.experienceType),null!=o.jobPostEducation&&$("#postedJobEducation").html(o.jobPostEducation.educationName),""!=o.jobPostDescription&&$("#postedJobDescription").html(o.jobPostDescription),null!=o.company.companyLocality&&$("#postedJobCompanyLocation").html(o.company.companyLocality.localityName),null!=o.company.companyLogo&&(document.getElementById("postedJobCompanyLogo").src=o.company.companyLogo,document.getElementById("postedCompanyLogo").src=o.company.companyLogo),null!=o.company.companyWebsite&&$("#postedJobCompanyWebsite").html(o.company.companyWebsite),""!=o.company.companyDescription&&$("#postedJobCompanyDescriotion").html(o.company.companyDescription),null!=o.company.compType&&$("#postedJobCompanyType").html(o.company.compType.companyTypeName)}var jobId=0,localityArray=[],jobArray=[];$(document).ready(function(){$(".navbar-nav li a").click(function(o){$(".navbar-collapse").collapse("hide")});var o=window.innerWidth;o<440&&$(".navbar-default").css("background-color","white"),$(window).scroll(function(){$(document).scrollTop()>150?($("#fixed-menu-shadow").css("background-color","#2980b9"),$("#fixed-menu-shadow").fadeIn(),$(".navbar-default").css("background-color","white")):($("#fixed-menu-shadow").css("background-color","rgba(0, 0, 0, 0.175)"),$("#fixed-menu-shadow").fadeOut())});try{$.ajax({type:"POST",url:"/getAllLocality",data:!1,contentType:!1,processData:!1,success:processDataCheckLocality})}catch(t){console.log("exception occured!!"+t)}try{$.ajax({type:"POST",url:"/getAllJobs",data:!1,contentType:!1,processData:!1,success:processDataCheckJobs})}catch(t){console.log("exception occured!!"+t)}try{$.ajax({type:"POST",url:"/getAllHotJobPosts",data:!1,contentType:!1,processData:!1,success:processDataAllJobPosts})}catch(t){console.log("exception occured!!"+t)}}),$(window).load(function(){$("html, body").css({overflow:"auto",height:"auto"}),$("#status").fadeOut(),$("#loaderLogo").fadeOut(),$("#preloader").delay(1e3).fadeOut("slow")}),$(document).ready(function(){var o=$(location).attr("href"),t=o.split("/");t.reverse();try{$.ajax({type:"GET",url:"/job/"+t[3]+"/"+t[2]+"/"+t[1]+"/"+t[0],contentType:"application/json; charset=utf-8",data:!1,processData:!1,success:processDataForHotJobPost})}catch(a){console.log("exception occured!!"+a)}}),$(function(){$("#jobLocality").change(function(){$(this).val()!=-1?(prefLocation=$(this).val(),prefLocationName=$("#jobLocality option:selected").text(),$("#applyButton").show()):$("#applyButton").hide()})});
function processDataResetCheckUser(e){1==e.status?(returnedOtp=e.otp,document.getElementById("helpText").innerHTML="Enter OTP sent on "+$("#resetPasswordMobile").val(),$("#form_password_reset_otp").show(),$("#form_forgot_password").hide(),$("#noUserLogin").hide()):(document.getElementById("resetCheckUserBtn").disabled=!1,$("#noUserLogin").show())}function processDataPostReset(e){console.log("returedData :"+e.status),1==e.status?(localStorage.setItem("mobile","+91"+candidateMobile),localStorage.setItem("name",e.candidateFirstName),localStorage.setItem("lastName",e.candidateLastName),localStorage.setItem("assessed",e.isAssessed),localStorage.setItem("minProfile",e.minProfile),1==applyJobFlag?($("#myLoginModal").modal("hide"),applyJob(applyJobId,prefLocation),applyJobFlag=0,applyJobId=0,$("#customSubMsg").html("Logging in ..."),$("#customSubMsg").modal({backdrop:"static",keyboard:!1}),setTimeout(function(){window.location="/dashboard/appliedJobs"},3e3)):window.location="/dashboard"):2==e.status?(document.getElementById("resetNewPasswordBtn").disabled=!1,$("#incorrectMsg").show(),$("#errorMsg").hide()):(document.getElementById("resetNewPasswordBtn").disabled=!1,$("#incorrectMsg").hide(),$("#errorMsg").show())}var returnedOtp,candidateMobile;$(function(){$("#form_forgot_password").submit(function(e){e.preventDefault();var t=$("#resetPasswordMobile").val(),s=validateMobile(t);if(0==s)alert("Enter a valid mobile number");else if(1==s)alert("Enter 10 digit mobile number");else{candidateMobile=t,document.getElementById("resetCheckUserBtn").disabled=!0;try{var a={resetPasswordMobile:t};$.ajax({type:"POST",url:"/findUserAndSendOtp",contentType:"application/json; charset=utf-8",data:JSON.stringify(a),success:processDataResetCheckUser})}catch(o){console.log("exception occured!!"+o)}}}),$("#form_password_reset_otp").submit(function(e){e.preventDefault();var t=$("#candidateForgotOtp").val();t==returnedOtp?($("#form_password_reset_otp").hide(),$("#form_password_reset_new").show(),$("#wrongOtp").hide()):$("#wrongOtp").show()}),$("#form_password_reset_new").submit(function(e){e.preventDefault();var t=$("#candidateNewPassword").val(),s=validatePassword(t);if(0==s)alert("Please set min 6 chars for password");else if(1==s)alert("Password cannot have blank spaces. Enter a valid password");else{document.getElementById("resetNewPasswordBtn").disabled=!0;try{var a=candidateMobile,o=$("#candidateNewPassword").val();console.log("phone: "+a);var r={candidatePassword:o,candidateAuthMobile:a};$.ajax({type:"POST",url:"/addPassword",contentType:"application/json; charset=utf-8",data:JSON.stringify(r),success:processDataPostReset})}catch(d){console.log("exception occured!!"+d)}}})});
function getLocality(){return localityArray}function getJob(){return jobArray}function processDataCheckLocality(e){e.forEach(function(e){var t=e.localityId,a=e.localityName,o={};o.id=t,o.name=a,localityArray.push(o)})}function processDataCheckJobs(e){e.forEach(function(e){var t=e.jobRoleId,a=e.jobName,o={};o.id=t,o.name=a,jobArray.push(o)})}function processDataCheckCompanyLogo(e){var t=Object.keys(e).length,a=Math.floor(t/3),o=t%3,n=0,c=0,i=$("#hiringCompanies"),l=document.createElement("div");l.className="item active",i.append(l),e.forEach(function(e){if(n>=c&&n<c+3){var t=document.createElement("div");t.className="col-sm-4",l.appendChild(t);var a=document.createElement("img");a.className="img-responsive",a.id="companyLogoSlider",a.setAttribute("alt","Companies Hiring"),a.src=e.companyLogo,t.appendChild(a)}if(n++,n>3)return!0});for(var r=3,s=1;s<a;s++)setCompanyLogos(e,r),r+=3;o>0&&(r=t-o,setCompanyLogos(e,r))}function setCompanyLogos(e,t){var a=0,o=$("#hiringCompanies"),n=document.createElement("div");n.className="item",o.append(n),e.forEach(function(e){if(a>=t&&a<t+3){var o=document.createElement("div");o.className="col-sm-4",n.appendChild(o);var c=document.createElement("img");c.className="img-responsive",c.id="companyLogoSlider",c.setAttribute("alt","Companies Hiring"),c.src=e.companyLogo,o.appendChild(c)}if(a++,a>t+3)return!0})}function processDataForSelectedJobPost(e){var t=$(location).attr("href"),a=t.split("/");a.reverse();for(var o,n=a[1].split("_"),c=[""],i=0;i<n.length;i++)o=n[i].charAt(0).toUpperCase()+n[i].substring(1),c+=o+" ";var l=c.replace(/%20/g," ");if($("#jobTitleLine").html("Register for "+l),$("#jobRoleTitle").html("Register for "+l),$("#applyToJobsTitle").html("Apply to "+l),""!=e){var r=Object.keys(e).length;if(r>0){var s=0,d=$("#hotJobs");e.reverse();try{e.forEach(function(e){if(s++,s){var t=e.jobPostToLocalityList,a="",o="",n=0;t.forEach(function(e){if(n++,n>2)return!1;var o=e.locality.localityName;a+=o,n<Object.keys(t).length&&(a+=", ")}),n=0,t.forEach(function(e){n++;var a=e.locality.localityName;o+=a,n<Object.keys(t).length&&(o+=", ")});var c=document.createElement("div");c.id="hotJobItem",d.append(c);var i=document.createElement("center");c.appendChild(i);var l=document.createElement("div");l.className="row",i.appendChild(l);var r=document.createElement("div");r.className="col-sm-2",l.appendChild(r);var m=document.createElement("img");m.src=e.company.companyLogo,m.setAttribute("width","80%"),m.id="jobLogo",r.appendChild(m);var p=document.createElement("div");p.className="col-sm-8",p.id="jobBody",l.appendChild(p);var h=document.createElement("h4");h.textContent=e.jobPostTitle+" | "+e.company.companyName,p.appendChild(h);var u=document.createElement("hr");p.appendChild(u);var g=document.createElement("div");g.className="row",g.id="jobBodyDetails",p.appendChild(g);var v=document.createElement("div");v.className="col-sm-4",v.id="jobSalary",g.appendChild(v);var y=document.createElement("div");y.className="row",v.appendChild(y);var b=document.createElement("div");b.className="col-sm-12",y.appendChild(b);var f=document.createElement("div");f.style="display : inline-block; margin: 4px;top:0",b.appendChild(f);var C=document.createElement("img");C.src="/assets/common/img/salary.svg",C.setAttribute("height","15px"),C.style="margin-top: -4px",f.appendChild(C);var E=document.createElement("div");E.style="display: inline-block; font-size: 14px","0"==e.jobPostMaxSalary?E.textContent=e.jobPostMinSalary+" monthly":E.textContent=e.jobPostMinSalary+" - "+e.jobPostMaxSalary+" monthly",b.appendChild(E);var j=document.createElement("div");j.className="col-sm-3",j.id="jobExp",g.appendChild(j);var L=document.createElement("div");L.className="row",j.appendChild(L);var x=document.createElement("div");x.className="col-sm-12",L.appendChild(x);var w=document.createElement("div");w.style="display : inline-block; margin: 4px;top:0",x.appendChild(w);var N=document.createElement("img");N.src="/assets/common/img/workExp.svg",N.setAttribute("height","15px"),N.style="margin-top: -4px",w.appendChild(N);var k=document.createElement("div");k.style="display: inline-block; font-size: 14px",k.textContent="Exp: "+e.jobPostExperience.experienceType,x.appendChild(k);var M=document.createElement("div");M.className="col-sm-5",M.id="jobLocation",g.appendChild(M);var T=document.createElement("div");T.className="row",M.appendChild(T);var P=document.createElement("div");P.className="col-sm-12",T.appendChild(P);var S=document.createElement("div");S.style="display : inline-block; margin: 4px;top:0",P.appendChild(S);var A=document.createElement("img");A.src="/assets/common/img/location.svg",A.setAttribute("height","15px"),A.style="margin-top: -4px",S.appendChild(A);var I=document.createElement("div");if(I.style="display: inline-block; font-size: 14px",I.textContent=a,P.appendChild(I),t.length-2>0){var _=document.createElement("a");_.id="locationMsg_"+e.jobPostId,_.title=o,_.style="color: #2980b9",_.textContent=" more",P.appendChild(_)}$("#locationMsg_"+e.jobPostId).attr("data-toggle","tooltip"),$(function(){$('[data-toggle="tooltip"]').tooltip()});var O=document.createElement("div");O.className="col-sm-2",l.appendChild(O);var D=document.createElement("div");D.className="jobApplyBtn",D.textContent="View Job",O.appendChild(D),D.onclick=function(){var t=e.jobPostTitle.replace("/","-");try{window.location.href="/jobs/"+t+"/Bengaluru/"+e.company.companyName+"/"+e.jobPostId}catch(a){console.log("exception occured!!"+a)}}}})}catch(m){console.log("exception occured!!"+m)}}}else{var d=$("#hotJobs"),p=document.createElement("div");p.id="hotJobItem",d.append(p);var h=document.createElement("center");p.appendChild(h);var u=document.createElement("div");u.className="row",h.appendChild(u);var g=document.createElement("div");g.className="col-sm-12",u.appendChild(g);var v=document.createElement("div");v.id="jobImage",g.appendChild(v);var y=document.createElement("img");y.id="jobImageSrc",v.appendChild(y),$("#jobImageSrc").attr("src","/assets/common/img/empty-search.svg");var b=document.createElement("div");b.id="jobMsgLine1",g.appendChild(b),$("#jobMsgLine1").html("Oops!! No relevant jobs found at this movement");var f=document.createElement("div");f.id="jobMsgLine2",g.appendChild(f),$("#jobMsgLine2").html("Register yourself to get updates when new jobs are posted")}}function processCheckLeadStatus(){$("#addLeadMobile").val(""),$("#messagePromptModal").modal("show"),$("#customMsg").html("Thanks! We will get back soon!")}function addLead(){var e=$("#addLeadMobile").val(),t=validateMobile(e);if(0==t)alert("Enter a valid mobile number");else if(1==t)alert("Enter 10 digit mobile number");else try{var a={leadName:"",leadMobile:$("#addLeadMobile").val(),leadChannel:0,leadType:1,leadInterest:"General Registration"};$.ajax({type:"POST",url:"/addLead",contentType:"application/json; charset=utf-8",data:JSON.stringify(a),success:processCheckLeadStatus})}catch(o){console.log("exception occured!!"+o)}}function openLogin(){$("#signInPopup").html("Sign In"),document.getElementById("resetCheckUserBtn").disabled=!1,document.getElementById("resetNewPasswordBtn").disabled=!1,$("#form_login_candidate").show(),$("#noUserLogin").hide(),$("#incorrectMsgLogin").hide(),$("#form_forgot_password").hide(),$("#errorMsgReset").hide(),$("#form_password_reset_otp").hide(),$("#form_password_reset_new").hide()}function openSignUp(){$("#myLoginModal").modal("hide")}function resetPassword(){$("#noUserLogin").hide(),$("#incorrectMsgLogin").hide(),$("#form_login_candidate").hide(),$("#form_forgot_password").show()}var localityArray=[],jobArray=[],prefLocation,prefLocationName;$(function(){$('a[href*="#"]:not([href="#"])').click(function(){if(location.pathname.replace(/^\//,"")==this.pathname.replace(/^\//,"")&&location.hostname==this.hostname){var e=$(this.hash);e=e.length?e:$("[name="+this.hash.slice(1)+"]"),e.length&&$("html, body").animate({scrollTop:e.offset().top-92},1e3)}})}),$(function(){$("#myRegistrationModal").on("hidden.bs.modal",function(){document.getElementById("registerBtn").disabled=!1,window.location="/"})}),$(window).load(function(){$("html, body").css({overflow:"auto",height:"auto"}),$("#status").fadeOut(),$("#loaderLogo").fadeOut(),$("#preloader").delay(1e3).fadeOut("slow")}),$(document).ready(function(){$(".navbar-nav li a").click(function(e){$(".navbar-collapse").collapse("hide")});var e=window.innerWidth;e<440&&$(".navbar-default").css("background-color","white"),$(window).scroll(function(){$(document).scrollTop()>150?($("#fixed-menu").css("background-color","#2980b9"),$("#fixed-menu").fadeIn(),$(".navbar-default").css("background-color","white")):($("#fixed-menu").css("background-color","rgba(0, 0, 0, 0.175)"),$("#fixed-menu").fadeOut())});try{$.ajax({type:"POST",url:"/getAllLocality",data:!1,contentType:!1,processData:!1,success:processDataCheckLocality})}catch(t){console.log("exception occured!!"+t)}try{$.ajax({type:"POST",url:"/getAllJobs",data:!1,contentType:!1,processData:!1,success:processDataCheckJobs})}catch(t){console.log("exception occured!!"+t)}var a=$(location).attr("href"),o=a.split("/");o.reverse(),$("#sectionOne").css("background-image","linear-gradient(rgba(24, 26, 45, 0.4),rgba(24, 26, 45, 0.4)),url(/assets/common/img/"+o[0]+".png)");try{$.ajax({type:"GET",url:"/jobs/"+o[1]+"/"+o[0],contentType:"application/json; charset=utf-8",data:!1,processData:!1,success:processDataForSelectedJobPost})}catch(t){console.log("exception occured!!"+t)}try{$.ajax({type:"POST",url:"/getAllCompanyLogos",data:!1,contentType:!1,processData:!1,success:processDataCheckCompanyLogo})}catch(t){console.log("exception occured!!"+t)}}),$(function(){$("#jobLocality").change(function(){$(this).val()!=-1?(prefLocation=$(this).val(),prefLocationName=$("#jobLocality option:selected").text(),$("#applyButton").show()):$("#applyButton").hide()})});
function processDataSignUpSubmit(a){if(console.log("returedData :"+a.status),1==a.status){returnedOtp=a.otp;try{$("#mySignUpModal").modal("hide")}catch(e){console.log(e)}$("#myRegistrationModal").modal("show"),$("#authMobile").val($("#candidateMobile").val()),$("#candidateFirstName").val(""),$("#candidateSecondName").val(""),$("#candidateMobile").val(""),$("#candidateEmail").val(""),document.getElementById("helpTextSignUp").innerHTML="Enter OTP sent on "+candidateMobile,$("#form_otp").show()}else 3==a.status?(alert("User already exists! Please login to continue"),window.location="/"):($("#errorMsg").show(),$("#candidateFirstName").val(""),$("#candidateMobile").val(""),$("#candidateEmail").val(""))}function processDataAddAuth(a){console.log("returedData :"+a.status),1==a.status?(localStorage.setItem("mobile","+91"+candidateMobile),localStorage.setItem("name",a.candidateFirstName),localStorage.setItem("lastName",a.candidateLastName),localStorage.setItem("id",a.candidateId),localStorage.setItem("leadId",a.leadId),localStorage.setItem("assessed",a.isAssessed),localStorage.setItem("minProfile",a.minProfile),1==applyJobFlag?($("#myRegistrationModal").modal("hide"),applyJob(applyJobId,prefLocation),applyJobFlag=0,applyJobId=0,$("#customSubMsg").html("Logging in ..."),$("#customSubMsg").modal({backdrop:"static",keyboard:!1}),setTimeout(function(){window.location="/dashboard/appliedJobs"},3e3)):window.location="/dashboard"):$("#errorMsg").show()}var returnedOtp,candidateMobile,applyJobFlag=0,applyJobId=0;$(function(){$("#form_signup_candidate").submit(function(a){a.preventDefault();var e=1,t=$("#candidateFirstName").val(),i=$("#candidateSecondName").val(),s=$("#candidateMobile").val(),n=validateName(t);if(""!=i)var l=validateName(i);var r=validateMobile(s),d=$("#candidateLocality").val(),o=$("#candidateJobPref").val();switch(n){case 0:alert("First name contains number. Please Enter a valid First Name"),e=0;break;case 2:alert("First Name cannot be blank spaces. Enter a valid first name"),e=0;break;case 3:alert("First name contains special symbols. Enter a valid first name"),e=0;break;case 4:alert("Please enter your first name"),e=0}switch(0==r?(alert("Enter a valid mobile number"),e=0):1==r?(alert("Enter 10 digit mobile number"),e=0):""==d?(alert("Please Enter your Job Localities"),e=0):""==o&&(alert("Please Enter the Jobs you are Interested"),e=0),l){case 0:alert("Last name contains number. Please Enter a valid Last Name"),e=0;break;case 2:alert("Last Name cannot be blank spaces. Enter a valid Last name"),e=0;break;case 3:alert("Last name contains special symbols. Enter a valid Last name"),e=0;break;case 4:alert("Please enter your Last name"),e=0}if(1==e){candidateMobile=s,$("#registerBtnSubmit").addClass("appliedBtn").removeClass("btn-primary").prop("disabled",!0).html("Please Wait"),$("#registerBtnSubmit").addClass("appliedBtn").removeClass("btn-primary").prop("disabled",!0).html("Please Wait"),document.getElementById("registerBtnSubmit").disabled=!0;try{var c,m=[],b=[],p=$("#candidateJobPref").val().split(","),u=$("#candidateLocality").val().split(",");for(c=0;c<p.length;c++)m.push(parseInt(p[c]));for(c=0;c<u.length;c++)b.push(parseInt(u[c]));$("#alreadyMsgCandidate").hide();var v={candidateFirstName:t,candidateSecondName:i,candidateMobile:s,candidateLocality:b,candidateJobPref:m};$.ajax({type:"POST",url:"/signUp",contentType:"application/json; charset=utf-8",data:JSON.stringify(v),success:processDataSignUpSubmit})}catch(g){console.log("exception occured!!"+g)}}})}),$(function(){$("#form_signup_candidate_modal").submit(function(a){a.preventDefault();var e=1,t=$("#candidateFirstNameModal").val(),i=$("#candidateSecondNameModal").val(),s=$("#candidateMobileModal").val(),n=validateName(t);if(""!=i)var l=validateName(i);var r=validateMobile(s),d=$("#candidateLocalityModal").val(),o=$("#candidateJobPrefModal").val();switch(n){case 0:alert("First name contains number. Please Enter a valid First Name"),e=0;break;case 2:alert("First Name cannot be blank spaces. Enter a valid first name"),e=0;break;case 3:alert("First name contains special symbols. Enter a valid first name"),e=0;break;case 4:alert("Please enter your first name"),e=0}switch(0==r?(alert("Enter a valid mobile number"),e=0):1==r?(alert("Enter 10 digit mobile number"),e=0):""==d?(alert("Please Enter your Job Localities"),e=0):""==o&&(alert("Please Enter the Jobs you are Interested"),e=0),l){case 0:alert("Last name contains number. Please Enter a valid Last Name"),e=0;break;case 2:alert("Last Name cannot be blank spaces. Enter a valid Last name"),e=0;break;case 3:alert("Last name contains special symbols. Enter a valid Last name"),e=0;break;case 4:alert("Please enter your Last name"),e=0}if(1==e){candidateMobile=s;try{document.getElementById("registerBtnSubmit").disabled=!0}catch(c){}try{document.getElementById("registerBtnSubmitModal").disabled=!0}catch(c){}try{var m,b=[],p=[],u=$("#candidateJobPrefModal").val().split(","),v=$("#candidateLocalityModal").val().split(",");for(m=0;m<u.length;m++)b.push(parseInt(u[m]));for(m=0;m<v.length;m++)p.push(parseInt(v[m]));$("#alreadyMsgCandidate").hide();var g={candidateFirstName:t,candidateSecondName:i,candidateMobile:s,candidateLocality:p,candidateJobPref:b};$.ajax({type:"POST",url:"/signUp",contentType:"application/json; charset=utf-8",data:JSON.stringify(g),success:processDataSignUpSubmit})}catch(f){console.log("exception occured!!"+f)}}})}),$(function(){$("#form_otp").submit(function(a){a.preventDefault();var e=$("#candidateOtp").val();e==returnedOtp?($("#incorrectOtpMsg").hide(),$("#form_otp").hide(),$("#form_auth").show(),$("#errorMsg").hide(),$("#incorrectMsg").hide()):($("#incorrectOtpMsg").show(),$("#errorMsg").hide(),$("#candidateOtp").val(""))})}),$(function(){$("#form_auth").submit(function(a){a.preventDefault();var e=$("#candidatePassword").val(),t=validatePassword(e);if(0==t)alert("Please set min 6 chars for password");else if(1==t)alert("Password cannot have blank spaces. Enter a valid password");else{document.getElementById("btnSubmit").disabled=!0;try{var i=$("#candidatePassword").val(),s=candidateMobile,n={candidatePassword:i,candidateAuthMobile:s};console.log("userMobile: "+s),$.ajax({type:"POST",url:"/addPassword",contentType:"application/json; charset=utf-8",data:JSON.stringify(n),success:processDataAddAuth})}catch(l){console.log("exception occured!!"+l)}}})});
function validateMobile(t){var e=/^[7-9]{1}[0-9]{9}$/i;return t.length>0&&e.test(t)===!1?0:0==t.length?1:2}function validateName(t){var e=/^[a-zA-Z]+$/,a=/^[ ]+$/,n=/[^\w\s]/gi,s=/^[a-zA-Z0-9]+$/;return e.test(t)?1:s.test(t)?0:1==a.test(t)?2:""==t?4:n.test(t)?3:1}function validatePassword(t){var e=/^[ ]+$/;return t.length<6?0:e.test(t)?(console.log("Password with blank spaces"),1):2}