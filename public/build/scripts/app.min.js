...
function processDataApplyJob(e){if($("#messagePromptModal").modal("show"),1==e.status){postToGoogle(),$("#customMsgIcon").attr("src","/assets/img/jobApplied.png"),$("#customMsg").html("Your Job Application is Successful");try{$("#"+applyJobId).addClass("appliedBtn").removeClass("btn-primary"),$("#"+applyJobId).prop("disabled",!0),$("#apply_btn_"+applyJobId).html("Already Applied")}catch(a){console.log(a)}}else 2==e.status?($("#customMsgIcon").attr("src","/assets/img/jobApplied.png"),$("#customMsg").html("Oops! Something went Wrong. Unable to apply")):3==e.status?($("#customMsgIcon").attr("src","/assets/img/alreadyApplied.png"),$("#customMsg").html("Looks like you already applied for this Job. Click My Jobs to view your applied Jobs")):4==e.status?($("#customMsgIcon").attr("src","/assets/img/logo.gif"),$("#customMsg").html("Oops! Candidate does't Exists")):($("#customMsgIcon").attr("src","/assets/img/logo.gif"),$("#customMsg").html("Oops! Looks like the job is no longer available"))}function applyJob(e){applyJobFlag=1,applyJobId=e;var a=localStorage.getItem("mobile");if(null==a)openLogin(),$("#myLoginModal").modal("show"),$("#signInPopup").html("Sign In to Apply");else try{var t={jobId:e,candidateMobile:a};$.ajax({type:"POST",url:"/applyJob",async:!1,contentType:"application/json; charset=utf-8",data:JSON.stringify(t),success:processDataApplyJob})}catch(o){console.log("exception occured!!"+o)}}function postToGoogle(){try{$.ajax({type:"GET",url:"/getJobApplicationDetailsForGoogleSheet/"+applyJobId,data:!1,async:!1,contentType:!1,processData:!1,success:processDataGetJobGoogleSheetDetails})}catch(e){console.log("exception occured!!"+e)}}function processDataGetJobGoogleSheetDetails(e){null!=e.candidateGender&&(candidateGender=0==e.candidateGender?"Male":"Female"),null!=e.candidateIsEmployed&&(isEmployed=0==e.candidateIsEmployed?"No":"Yes"),null!=e.candidateIsAssessed&&(isAssessed=0==e.candidateIsAssessed?"No":"Yes");var a=e.candidateCreationTimestamp,t=new Date(a).toLocaleDateString()+" "+new Date(a).getHours()+":"+new Date(a).getMinutes()+":"+new Date(a).getSeconds(),o=e.formUrl;try{$.ajax({url:o,data:{"entry.1388755113":applyJobId,"entry.1115234203":null!=e.companyName?e.companyName:"","entry.1422779518":null!=e.jobRoleName?e.jobRoleName:"","entry.942294281":null!=e.candidateLeadId?e.candidateLeadId:"","entry.1345077393":null!=e.candidateName?e.candidateName:"","entry.1859090779":null!=e.candidateMobile?e.candidateMobile:"","entry.2079461892":candidateGender,"entry.2071290015":null!=e.candidateTotalExp?e.candidateTotalExp:"","entry.179139422":isEmployed,"entry.1488146275":isAssessed,"entry.67497584":null!=e.languageKnown?e.languageKnown:"","entry.441069988":null!=e.candidateMotherTongue?e.candidateMotherTongue:"","entry.1350761294":null!=e.candidateHomeLocality?e.candidateHomeLocality:"","entry.2057814300":null!=e.candidateLocalityPref?e.candidateLocalityPref:"","entry.598773915":null!=e.candidateJobPref?e.candidateJobPref:"","entry.125850326":null!=e.candidateCurrentSalary?e.candidateCurrentSalary:"","entry.240702722":null!=e.candidateEducation?e.candidateEducation:"","entry.190053755":null!=e.candidateSkill?e.candidateSkill:"","entry.971982828":t},type:"POST",dataType:"xml"})}catch(n){console.log("exception occured!!"+n)}}var companyName,candidateId,candidateGender,isEmployed,isAssessed,salary,education,homeLocality;
