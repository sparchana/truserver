...
function updateCallAttempts(e,t,n){if(null==e||null==t)return void console.log("invalid candidateId and jobPostId");NProgress.start();var o="/support/api/updatePreScreenAttempt/";$.ajax({type:"GET",url:o+"?candidateId="+e+"&jobPostId="+t+"&callStatus="+n,processData:!1,success:function(e){"OK"==e?(notifyError("Call response saved successfully. Refreshing..","success"),setTimeout(function(){location.reload()},2e3),bootbox.hideAll()):"NA"==e&&notifyError("Error while saving call response.","success")}}),NProgress.done()}function saveAttempt(e,t){var n=$("#callResponse").val();updateCallAttempts(e,t,n),bootbox.hideAll()}function onCallYes(e,t){console.log("connected: "+e+" "+t),$("#callNoClass").hide(),$("#pre_screen_body").show(),updateCallAttempts(e,t,"CONNECTED"),activateSubmit()}function activateSubmit(){null!=$('input:radio[name="verdict"]:checked').val()&&"yes"==$('input:radio[name="callConnected"]:checked').val()&&$(".btn.modal-submit").prop("disabled",!1)}function onCallNo(e,t){$("#callNoClass").show(),$("#pre_screen_body").hide(),$(".btn.modal-submit").prop("disabled",!0)}function triggerPreScreenResponseSubmission(e,t){for(var n=$("#pre_screen_body input[type='checkbox']:checked"),o=[],a=n.size(),l=0;l<a;l++){var d=n[l],c=d.id.split("_"),r=c[1].split("-"),i=r.length;if(r.length>1)for(var s=0;s<i;s++)o.push(parseInt(r[s]));else o.push(parseInt(c[1]))}var p=!1;if(null!=$('input:radio[name="verdict"]:checked').val()&&(p=!0),p){var m={candidateId:e,jobPostId:t,preScreenIdList:o,pass:1==$('input:radio[name="verdict"]:checked').val(),preScreenNote:$("#pre_screen_note").val()};try{$.ajax({type:"POST",url:"/submitPreScreen",contentType:"application/json; charset=utf-8",data:JSON.stringify(m),success:processPostPreScreenResponse})}catch(u){console.log("exception occured!!"+u)}}}function processPreScreenContent(e){if(null!=e&&"SUCCESS"==e.status||(console.log(e),pushToSnackbar("Request failed. Something went Wrong! Please Refresh")),null!=e){var t=e.candidateId,n=e.jobPostId,o=$('<div id="pre_screen_body" class="mdl-grid"></div>'),a=$('<div class="row mdl-cell mdl-cell--12-col" id="pre_screen_container_row"></div>');o.append(a);var l=$('<div id="minReqTable"></div>');a.append('<h4 style="margin-top: 0">Min Requirement</h4>'),a.append(l);var d=$('<div id="otherReqTable"></div>');a.append("<h4>Other Requirement</h4>"),a.append(d);var c=document.createElement("table");c.className="mdl-data-table mdl-js-data-table mdl-shadow--2dp mdl-cell mdl-cell--12-col",c.style="margin:0;border:none";var r=document.createElement("thead");r.style="background-color:rgb(63,81,181)",c.appendChild(r);var i=document.createElement("tr");r.appendChild(i);var s=document.createElement("th");s.textContent="",i.appendChild(s);var p=document.createElement("th");p.textContent="Job Post Info",p.style="color:#ffffff",i.appendChild(p);var m=document.createElement("th");m.style="color:#ffffff",m.textContent="Candidate Info",i.appendChild(m);var u=document.createElement("th");u.textContent="Match?",u.style="color:#ffffff",i.appendChild(u);var h=document.createElement("th");h.style="color:#ffffff",h.textContent="Is candidate Ready",i.appendChild(h);var b=document.createElement("tbody");c.appendChild(b),l.append(c);var v=document.createElement("table");v.className="mdl-data-table mdl-js-data-table mdl-shadow--2dp mdl-cell mdl-cell--12-col",v.style="margin:0;border:none";var r=document.createElement("thead");r.style="background-color:rgb(63,81,181)",v.appendChild(r);var i=document.createElement("tr");r.appendChild(i);var s=document.createElement("th");s.textContent="",i.appendChild(s);var p=document.createElement("th");p.style="color:#ffffff",p.textContent="Job Post Info",i.appendChild(p);var m=document.createElement("th");m.style="color:#ffffff",m.textContent="Candidate Info",i.appendChild(m);var u=document.createElement("th");u.style="color:#ffffff",u.textContent="Match?",i.appendChild(u);var h=document.createElement("th");h.style="color:#ffffff",h.textContent="Is candidate Ready",i.appendChild(h);var f=document.createElement("tbody");v.appendChild(f),d.append(v);var y=$('<div class="row"></div>'),C=document.createElement("div");C.className="col-xs-6 form-group";var g=document.createElement("textarea");g.className="form-control",g.rows="5",g.type="text",g.id="pre_screen_note";var x=document.createElement("div");x.className="col-xs-6 form-group";var E=document.createElement("textarea");E.className="form-control",E.rows="5",E.type="text",E.id="job_post_min_req",E.disabled=!0;var k;k=null!=e.jobPostMinReq&&""!=e.jobPostMinReq?e.jobPostMinReq:"NA",E.textContent=k;var S=document.createElement("label");S["for"]="job_post_min_req",S.textContent="Job Post Min Req",x.appendChild(S),x.appendChild(E),y.append(x);var S=document.createElement("label");S["for"]="pre_screen_note",S.textContent="Note",C.appendChild(S),C.appendChild(g),y.append(C),a.append(y);var _=e.elementList;_.forEach(function(e){if(console.log("ptitle:"+e.propertyTitle),null!=e)if(e.isMinReq){var t=document.createElement("tr");t.id=e.propertyId,b.appendChild(t);var n=document.createElement("td");n.textContent=e.propertyTitle,t.appendChild(n);var o=document.createElement("td");t.appendChild(o);var a=document.createElement("td");t.appendChild(a),e.isSingleEntity?(a.textContent=e.candidateElement,o.textContent=e.jobPostElement):(a.textContent=e.candidateElementList,o.textContent=e.jobPostElementList);var l=document.createElement("td"),d=document.createElement("span");e.isMatching?d.setAttribute("class","glyphicon glyphicon-ok"):d.setAttribute("class","glyphicon glyphicon-remove"),l.appendChild(d),t.appendChild(l);var c=document.createElement("td");t.appendChild(c);var r=document.createElement("label");r.type="checkbox",r["for"]="checkbox_"+e.propertyIdList.join("-"),r.style="text-align:center",r.className="mdl-checkbox mdl-js-checkbox mdl-js-ripple-effect",c.appendChild(r);var i=document.createElement("input");i.type="checkbox",i.id="checkbox_"+e.propertyIdList.join("-"),i.className="mdl-checkbox__input",r.appendChild(i)}else{var t=document.createElement("tr");t.id=e.propertyId,f.appendChild(t);var n=document.createElement("td");n.textContent=e.propertyTitle,t.appendChild(n);var o=document.createElement("td");t.appendChild(o);var a=document.createElement("td");t.appendChild(a),e.isSingleEntity?(a.textContent=e.candidateElement,o.textContent=e.jobPostElement):(a.textContent=e.candidateElementList,o.textContent=e.jobPostElementList);var l=document.createElement("td"),d=document.createElement("span");e.isMatching?d.setAttribute("class","glyphicon glyphicon-ok"):d.setAttribute("class","glyphicon glyphicon-remove"),l.appendChild(d),t.appendChild(l);var c=document.createElement("td");t.appendChild(c);var r=document.createElement("label");r.type="checkbox",r["for"]="checkbox_"+e.propertyIdList.join("-"),r.style="text-align:center",r.className="mdl-checkbox mdl-js-checkbox mdl-js-ripple-effect",c.appendChild(r);var i=document.createElement("input");i.type="checkbox",i.id="checkbox_"+e.propertyIdList.join("-"),i.className="mdl-checkbox__input",r.appendChild(i)}});var j=$('<div class="row"><div class="col-sm-6"><h5 id="callConfirmation" style="margin:2px">Call Connected? :&nbsp; <input type="radio" name="callConnected" id="callYes" value="yes" onclick="onCallYes('+t+", "+n+')">&nbsp;Yes&nbsp; <input type="radio" name="callConnected" id="callNo" value="no"  onclick="onCallNo('+t+", "+n+')">&nbsp;No <div id="callNoClass" style="display: none;"><h6>Reason?:<select id="callResponse" class="selectDropdown" style="margin: 0 8px;" ><option value="busy">Busy</option><option value="not_reachable">Not Reachable</option><option value="not_answering">Not Answering</option><option value="switched_off">Switched Off</option><option value="dnd">DND</option><option value="third_person">Third Person</option><option value="others">Others</option></select><button type="submit" id="responseSaveBtn"  class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect" onclick="saveAttempt('+t+", "+n+')">Save</button></h6></div></h5></div></div>'),N=bootbox.dialog({className:"pre-screen-modal",title:j,message:o,closeButton:!0,animate:!0,onEscape:function(){$("body").removeClass("open-modal")},buttons:{Submit:{className:"mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent modal-submit",callback:function(){return 0==$("#pre_screen_body input[type='checkbox']:checked").size()&&null==$('input:radio[name="verdict"]:checked').val()?(bootbox.alert({size:"small",title:"Invalid Submission !",message:"If you want to mark the candidate as  'completed_prescreening' irrespective of given criteria, select checkbox present next to submit button, in previous dialog.",callback:function(){}}),!1):($("body").removeClass("open-modal"),triggerPreScreenResponseSubmission(t,n),console.log("final prescreen submission triggered"),!0)}}}});N.init(function(){var e=$(".modal-footer"),t=$('<div class="col-xs-11" style="text-align: left"><h5 style="margin:2px; font-size: 12px;"><div style="display:inline-block; margin: 0 1px;text-align: left; color: #b9151b">*</div>Did the candidate pass pre-screen?&nbsp;:&nbsp;<div style="display: inline-block; vertical-align: middle; margin: 0px;"><input type="radio" name="verdict" id="pass" value="1" style="margin: 0 2px" onclick="activateSubmit()">Yes<input type="radio" name="verdict" id="fail" value="0" style="margin: 0 2px" onclick="activateSubmit()">No</div></h5></div>');e.prepend(t),$(".btn.modal-submit").prop("disabled",!0),$("#pre_screen_body").hide(),$("body").removeClass("modal-open").removeClass("open-modal").addClass("open-modal")})}}function processPostPreScreenResponse(e){console.log(e),"OK"==e?(notifyError("Submitted successfully. Refreshing ..","success"),setTimeout(function(){location.reload()},2e3)):notifyError("Error! Something Went wrong please try again.","danger")}function getPreScreenContent(e,t){var n="/support/api/getJobPostVsCandidate/";if(null==n||null==e)return void console.log("please provide candidateId && jobPostId");n+="?",null!=e&&(n+="jobPostId="+e),null!=t&&(n+="&candidateId="+t);try{$.ajax({type:"GET",url:n,data:!1,async:!1,contentType:!1,processData:!1,success:processPreScreenContent})}catch(o){console.log("exception occured!!"+o.stack)}}function pushToSnackbar(e){"use strict";var t=document.querySelector("#tru-snackbar"),n={message:JSON.stringify(e),timeout:4e3};t.MaterialSnackbar.showSnackbar(n)}function notifyError(e,t){$.notify({message:e,animate:{enter:"animated lightSpeedIn",exit:"animated lightSpeedOut"}},{type:t,placement:{from:"top",align:"center"}})}