...
function getLocality(){return localityArray}function getJob(){return jobArray}function processDataCheckLocality(e){e.forEach(function(e){var o=e.localityId,a=e.localityName,n={};n.id=o,n.name=a,localityArray.push(n)})}function processDataCheckJobs(e){e.forEach(function(e){var o=e.jobRoleId,a=e.jobName,n={};n.id=o,n.name=a,jobArray.push(n)})}function processCheckLeadStatus(){alert("Thanks! We will get back soon!"),$("#addLeadMobile").val("")}function addLead(){var e=$("#addLeadMobile").val(),o=validateMobile(e);if(0==o)alert("Enter a valid mobile number");else if(1==o)alert("Enter 10 digit mobile number");else try{var a={leadName:"",leadMobile:$("#addLeadMobile").val(),leadChannel:0,leadType:1,leadInterest:"General Registration"};$.ajax({type:"POST",url:"/addLead",contentType:"application/json; charset=utf-8",data:JSON.stringify(a),success:processCheckLeadStatus})}catch(n){console.log("exception occured!!"+n)}}function openLogin(){document.getElementById("resetCheckUserBtn").disabled=!1,document.getElementById("resetNewPasswordBtn").disabled=!1,$("#form_login_candidate").show(),$("#noUserLogin").hide(),$("#incorrectMsgLogin").hide(),$("#form_forgot_password").hide(),$("#errorMsgReset").hide(),$("#form_password_reset_otp").hide(),$("#form_password_reset_new").hide()}function resetPassword(){$("#noUserLogin").hide(),$("#incorrectMsgLogin").hide(),$("#form_login_candidate").hide(),$("#form_forgot_password").show()}var localityArray=[],jobArray=[];$(function(){$("#myRegistrationModal").on("hidden.bs.modal",function(){document.getElementById("registerBtn").disabled=!1,window.location="/"})}),$(document).ready(function(){$(".navbar-nav li a").click(function(e){$(".navbar-collapse").collapse("hide")});var e=window.innerWidth;440>e&&$(".navbar-default").css("background-color","white"),$(window).scroll(function(){if($(document).scrollTop()>50){$("#fixed-menu").css("background-color","#2980b9");var e=window.innerWidth;if(e>440){$(".navbar-fixed-top").removeClass("fade-transparent").addClass("fade-background"),$("#navItem1").css("color","#747474"),$("#navItem2").css("color","#747474"),$("#navItem3").css("color","#747474"),$("#navItem4").css("color","#747474"),$("#navItem5").css("color","#747474");var o=document.getElementById("navLogo");o.src="/assets/new/img/logo-color.gif"}}else{$("#fixed-menu").css("background-color","rgba(0, 0, 0, 0.175)");var e=window.innerWidth;if(e>480){$(".navbar-fixed-top").removeClass("fade-background").addClass("fade-transparent"),$("#navItem1").css("color","#ffffff"),$("#navItem2").css("color","#ffffff"),$("#navItem3").css("color","#ffffff"),$("#navItem4").css("color","#ffffff"),$("#navItem5").css("color","#ffffff");var o=document.getElementById("navLogo");o.src="/assets/new/img/logo-main.gif";var e=window.innerWidth;480>e&&($("#fixed-menu").css("background-color","transparent"),$("#navItem1").css("color","#747474"),$("#navItem2").css("color","#747474"),$("#navItem3").css("color","#747474"),$("#navItem4").css("color","#747474"),$("#navItem5").css("color","#747474"))}}});try{$.ajax({type:"POST",url:"/getAllLocality",data:!1,async:!1,contentType:!1,processData:!1,success:processDataCheckLocality})}catch(o){console.log("exception occured!!"+o)}try{$.ajax({type:"GET",url:"/getAllJobs",data:!1,async:!1,contentType:!1,processData:!1,success:processDataCheckJobs})}catch(o){console.log("exception occured!!"+o)}});
