...
function getLocality(){return localityArray}function getJob(){return jobArray}function processDataCheckLocality(e){e.forEach(function(e){var t=e.localityId,o=e.localityName,a={};a.id=t,a.name=o,localityArray.push(a)})}function processDataCheckJobs(e){e.forEach(function(e){var t=e.jobRoleId,o=e.jobName,a={};a.id=t,a.name=o,jobArray.push(a)})}function processDataAllJobPosts(e){var t=Object.keys(e).length;if(t>0){var o=0,a=$("#hotJobs");e.reverse(),e.forEach(function(e){if(o++,o){var t=e.jobPostToLocalityList,n="",l="",c=0;t.forEach(function(e){if(c++,c>2)return!1;var o=e.locality.localityName;n+=o,c<Object.keys(t).length&&(n+=", ")}),c=0,t.forEach(function(e){c++;var o=e.locality.localityName;l+=o,c<Object.keys(t).length&&(l+=", ")});var i=document.createElement("div");i.id="hotJobItem",a.append(i);var d=document.createElement("center");i.appendChild(d);var r=document.createElement("div");r.className="row",d.appendChild(r);var s=document.createElement("div");s.className="col-sm-2",r.appendChild(s);var p=document.createElement("img");p.src=e.company.companyLogo,p.setAttribute("width","80%"),p.id="jobLogo",s.appendChild(p);var m=document.createElement("div");m.className="col-sm-8",m.id="jobBody",r.appendChild(m);var u=document.createElement("h4");u.textContent=e.jobPostTitle+" | "+e.company.companyName,m.appendChild(u);var h=document.createElement("hr");m.appendChild(h);var y=document.createElement("div");y.className="row",y.id="jobBodyDetails",m.appendChild(y);var b=document.createElement("div");b.className="col-sm-4",b.id="jobSalary",y.appendChild(b);var v=document.createElement("div");v.className="row",b.appendChild(v);var f=document.createElement("div");f.className="col-sm-12",v.appendChild(f);var g=document.createElement("div");g.style="display : inline-block; margin: 4px;top:0",f.appendChild(g);var C=document.createElement("img");C.src="/assets/img/salary.svg",C.setAttribute("height","15px"),C.style="margin-top: -4px",g.appendChild(C);var E=document.createElement("div");E.style="display: inline-block; font-size: 14px","0"==e.jobPostMaxSalary?E.textContent=e.jobPostMinSalary+" monthly":E.textContent=e.jobPostMinSalary+" - "+e.jobPostMaxSalary+" monthly",f.appendChild(E);var j=document.createElement("div");j.className="col-sm-3",j.id="jobExp",y.appendChild(j);var x=document.createElement("div");x.className="row",j.appendChild(x);var L=document.createElement("div");L.className="col-sm-12",x.appendChild(L);var w=document.createElement("div");w.style="display : inline-block; margin: 4px;top:0",L.appendChild(w);var P=document.createElement("img");P.src="/assets/img/workExp.svg",P.setAttribute("height","15px"),P.style="margin-top: -4px",w.appendChild(P);var N=document.createElement("div");N.style="display: inline-block; font-size: 14px",N.textContent="Exp: "+e.jobPostExperience.experienceType,L.appendChild(N);var k=document.createElement("div");k.className="col-sm-5",k.id="jobLocation",y.appendChild(k);var T=document.createElement("div");T.className="row",k.appendChild(T);var A=document.createElement("div");A.className="col-sm-12",T.appendChild(A);var M=document.createElement("div");M.style="display : inline-block; margin: 4px;top:0",A.appendChild(M);var I=document.createElement("img");I.src="/assets/img/location.svg",I.setAttribute("height","15px"),I.style="margin-top: -4px",M.appendChild(I);var S=document.createElement("div");if(S.style="display: inline-block; font-size: 14px",S.textContent=n,A.appendChild(S),t.length-2>0){var _=document.createElement("a");_.id="locationMsg_"+e.jobPostId,_.title=l,_.style="color: #2980b9",_.textContent=" more",A.appendChild(_)}$("#locationMsg_"+e.jobPostId).attr("data-toggle","tooltip"),$(function(){$('[data-toggle="tooltip"]').tooltip()});var B=document.createElement("div");B.className="col-sm-2",B.onclick=function(){$("#jobApplyConfirm").modal(),jobPostId=e.jobPostId,jobLocalityArray=[],$("#applyButton").hide(),addLocalitiesToModal()},r.appendChild(B);var J=document.createElement("div");J.className="jobApplyBtn",J.textContent="Apply",B.appendChild(J)}})}}function addLocalitiesToModal(){$("#applyButton").addClass("jobApplyBtnModal").removeClass("appliedBtn").prop("disabled",!1).html("Apply");try{$.ajax({type:"POST",url:"/getJobPostInfo/"+jobPostId+"/0",data:!1,contentType:!1,processData:!1,success:processDataForJobPostLocation})}catch(e){console.log("exception occured!!"+e)}}function processDataForJobPostLocation(e){$("#jobNameConfirmation").html(e.jobPostTitle),$("#companyNameConfirmation").html(e.company.companyName),$("#jobLocality").html("");var t=$('<option value="-1"></option>').text("Select Preferred Location");$("#jobLocality").append(t);var o=e.jobPostToLocalityList;o.forEach(function(e){var t={};t.id=e.locality.localityId,t.name=" "+e.locality.localityName,jobLocalityArray.push(t);var o=$("<option value="+e.locality.localityId+"></option>").text(e.locality.localityName);$("#jobLocality").append(o)})}function confirmApply(){applyJob(jobPostId,prefLocation)}function processCheckLeadStatus(){$("#addLeadMobile").val(""),$("#messagePromptModal").modal("show"),$("#customMsg").html("Thanks! We will get back soon!")}function addLead(){var e=$("#addLeadMobile").val(),t=validateMobile(e);if(0==t)alert("Enter a valid mobile number");else if(1==t)alert("Enter 10 digit mobile number");else try{var o={leadName:"",leadMobile:$("#addLeadMobile").val(),leadChannel:0,leadType:1,leadInterest:"General Registration"};$.ajax({type:"POST",url:"/addLead",contentType:"application/json; charset=utf-8",data:JSON.stringify(o),success:processCheckLeadStatus})}catch(a){console.log("exception occured!!"+a)}}function openLogin(){$("#signInPopup").html("Sign In"),document.getElementById("resetCheckUserBtn").disabled=!1,document.getElementById("resetNewPasswordBtn").disabled=!1,$("#form_login_candidate").show(),$("#noUserLogin").hide(),$("#incorrectMsgLogin").hide(),$("#form_forgot_password").hide(),$("#errorMsgReset").hide(),$("#form_password_reset_otp").hide(),$("#form_password_reset_new").hide()}function openSignUp(){$("#myLoginModal").modal("hide")}function resetPassword(){$("#noUserLogin").hide(),$("#incorrectMsgLogin").hide(),$("#form_login_candidate").hide(),$("#form_forgot_password").show()}var localityArray=[],jobArray=[],prefLocation,prefLocationName;$(function(){$('a[href*="#"]:not([href="#"])').click(function(){if(location.pathname.replace(/^\//,"")==this.pathname.replace(/^\//,"")&&location.hostname==this.hostname){var e=$(this.hash);e=e.length?e:$("[name="+this.hash.slice(1)+"]"),e.length&&$("html, body").animate({scrollTop:e.offset().top-92},1e3)}})}),$(function(){$("#hotJobs").scroll(function(){var e=window.innerWidth;e<440?document.documentElement.scrollTop=document.body.scrollTop=280:document.documentElement.scrollTop=document.body.scrollTop=248})}),$(function(){$("#myRegistrationModal").on("hidden.bs.modal",function(){document.getElementById("registerBtn").disabled=!1,window.location="/"})}),$(window).load(function(){$("html, body").css({overflow:"auto",height:"auto"}),$("#status").fadeOut(),$("#loaderLogo").fadeOut(),$("#preloader").delay(1e3).fadeOut("slow")}),$(document).ready(function(){localStorage.clear(),$(".navbar-nav li a").click(function(e){$(".navbar-collapse").collapse("hide")});var e=window.innerWidth;e<440&&$(".navbar-default").css("background-color","white"),$(window).scroll(function(){$(document).scrollTop()>150?($("#fixed-menu").css("background-color","#2980b9"),$("#fixed-menu").fadeIn(),$(".navbar-default").css("background-color","white")):($("#fixed-menu").css("background-color","rgba(0, 0, 0, 0.175)"),$("#fixed-menu").fadeOut())});try{$.ajax({type:"POST",url:"/getAllLocality",data:!1,contentType:!1,processData:!1,success:processDataCheckLocality})}catch(t){console.log("exception occured!!"+t)}try{$.ajax({type:"POST",url:"/getAllJobs",data:!1,contentType:!1,processData:!1,success:processDataCheckJobs})}catch(t){console.log("exception occured!!"+t)}try{$.ajax({type:"POST",url:"/getAllHotJobPosts",data:!1,contentType:!1,processData:!1,success:processDataAllJobPosts})}catch(t){console.log("exception occured!!"+t)}}),$(function(){$("#jobLocality").change(function(){$(this).val()!=-1?(prefLocation=$(this).val(),prefLocationName=$("#jobLocality option:selected").text(),$("#applyButton").show()):$("#applyButton").hide()})});
