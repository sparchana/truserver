...
function getLocality(){return localityArray}function getJob(){return jobArray}function processDataCheckLocality(e){e.forEach(function(e){var t=e.localityId,a=e.localityName,o={};o.id=t,o.name=a,localityArray.push(o)})}function processDataCheckJobs(e){e.forEach(function(e){var t=e.jobRoleId,a=e.jobName,o={};o.id=t,o.name=a,jobArray.push(o)})}function processDataAllJobPosts(e){var t=Object.keys(e).length;if(t>0){var a=0,o=$("#hotJobs");e.forEach(function(e){if(a++,a){var t=e.jobPostToLocalityList,n="",l="",c=0;t.forEach(function(e){if(c++,c>2)return!1;var a=e.locality.localityName;n+=a,c<Object.keys(t).length&&(n+=", ")}),c=0,t.forEach(function(e){c++;var a=e.locality.localityName;l+=a,c<Object.keys(t).length&&(l+=", ")});var d=document.createElement("div");d.id="hotJobItem",o.append(d);var i=document.createElement("center");d.appendChild(i);var s=document.createElement("div");s.className="row",i.appendChild(s);var r=document.createElement("div");r.className="col-sm-2",s.appendChild(r);var m=document.createElement("img");m.src=e.company.companyLogo,m.setAttribute("width","80%"),m.id="jobLogo",r.appendChild(m);var p=document.createElement("div");p.className="col-sm-8",p.id="jobBody",s.appendChild(p);var u=document.createElement("h4");u.textContent=e.jobPostTitle+" | "+e.company.companyName,p.appendChild(u);var h=document.createElement("hr");p.appendChild(h);var y=document.createElement("div");y.className="row",y.id="jobBodyDetails",p.appendChild(y);var v=document.createElement("div");v.className="col-sm-4",v.id="jobSalary",y.appendChild(v);var b=document.createElement("div");b.className="row",v.appendChild(b);var g=document.createElement("div");g.className="col-sm-12",b.appendChild(g);var f=document.createElement("div");f.style="display : inline-block; margin: 4px;top:0",g.appendChild(f);var E=document.createElement("img");E.src="/assets/img/salary.svg",E.setAttribute("height","15px"),E.style="margin-top: -4px",f.appendChild(E);var C=document.createElement("div");C.style="display: inline-block; font-size: 14px","0"==e.jobPostMaxSalary?C.textContent=e.jobPostMinSalary+" monthly":C.textContent=e.jobPostMinSalary+" - "+e.jobPostMaxSalary+" monthly",g.appendChild(C);var x=document.createElement("div");x.className="col-sm-3",x.id="jobExp",y.appendChild(x);var w=document.createElement("div");w.className="row",x.appendChild(w);var j=document.createElement("div");j.className="col-sm-12",w.appendChild(j);var k=document.createElement("div");k.style="display : inline-block; margin: 4px;top:0",j.appendChild(k);var L=document.createElement("img");L.src="/assets/img/workExp.svg",L.setAttribute("height","15px"),L.style="margin-top: -4px",k.appendChild(L);var N=document.createElement("div");N.style="display: inline-block; font-size: 14px",N.textContent="Exp: "+e.jobPostExperience.experienceType,j.appendChild(N);var P=document.createElement("div");P.className="col-sm-5",P.id="jobLocation",y.appendChild(P);var T=document.createElement("div");T.className="row",P.appendChild(T);var M=document.createElement("div");M.className="col-sm-12",T.appendChild(M);var A=document.createElement("div");A.style="display : inline-block; margin: 4px;top:0",M.appendChild(A);var _=document.createElement("img");_.src="/assets/img/location.svg",_.setAttribute("height","15px"),_.style="margin-top: -4px",A.appendChild(_);var S=document.createElement("div");if(S.style="display: inline-block; font-size: 14px",S.textContent=n,M.appendChild(S),t.length-2>0){var I=document.createElement("a");I.id="locationMsg_"+e.jobPostId,I.title=l,I.style="color: #2980b9",I.textContent=" more",M.appendChild(I)}$("#locationMsg_"+e.jobPostId).attr("data-toggle","tooltip");var J=document.createElement("div");J.className="col-sm-2",J.onclick=function(){applyJob(e.jobPostId)},s.appendChild(J);var O=document.createElement("div");O.className="jobApplyBtn",O.textContent="Apply",J.appendChild(O)}})}}function processCheckLeadStatus(){$("#addLeadMobile").val(""),$("#messagePromptModal").modal("show"),$("#customMsg").html("Thanks! We will get back soon!")}function addLead(){var e=$("#addLeadMobile").val(),t=validateMobile(e);if(0==t)alert("Enter a valid mobile number");else if(1==t)alert("Enter 10 digit mobile number");else try{var a={leadName:"",leadMobile:$("#addLeadMobile").val(),leadChannel:0,leadType:1,leadInterest:"General Registration"};$.ajax({type:"POST",url:"/addLead",contentType:"application/json; charset=utf-8",data:JSON.stringify(a),success:processCheckLeadStatus})}catch(o){console.log("exception occured!!"+o)}}function openLogin(){$("#signInPopup").html("Sign In"),document.getElementById("resetCheckUserBtn").disabled=!1,document.getElementById("resetNewPasswordBtn").disabled=!1,$("#form_login_candidate").show(),$("#noUserLogin").hide(),$("#incorrectMsgLogin").hide(),$("#form_forgot_password").hide(),$("#errorMsgReset").hide(),$("#form_password_reset_otp").hide(),$("#form_password_reset_new").hide()}function openSignUp(){$("#myLoginModal").modal("hide")}function resetPassword(){$("#noUserLogin").hide(),$("#incorrectMsgLogin").hide(),$("#form_login_candidate").hide(),$("#form_forgot_password").show()}var localityArray=[],jobArray=[];$(function(){$('a[href*="#"]:not([href="#"])').click(function(){if(location.pathname.replace(/^\//,"")==this.pathname.replace(/^\//,"")&&location.hostname==this.hostname){var e=$(this.hash);e=e.length?e:$("[name="+this.hash.slice(1)+"]"),e.length&&$("html, body").animate({scrollTop:e.offset().top-92},1e3)}})}),$(function(){$("#hotJobs").scroll(function(){var e=window.innerWidth;440>e?document.documentElement.scrollTop=document.body.scrollTop=280:document.documentElement.scrollTop=document.body.scrollTop=248})}),$(function(){$("#myRegistrationModal").on("hidden.bs.modal",function(){document.getElementById("registerBtn").disabled=!1,window.location="/"})}),$(window).load(function(){$("html, body").css({overflow:"auto",height:"auto"}),$("#status").fadeOut(),$("#loaderLogo").fadeOut(),$("#preloader").delay(1e3).fadeOut("slow")}),$(document).ready(function(){localStorage.clear(),$(".navbar-nav li a").click(function(e){$(".navbar-collapse").collapse("hide")});var e=window.innerWidth;440>e&&$(".navbar-default").css("background-color","white"),$(window).scroll(function(){$(document).scrollTop()>150?($("#fixed-menu").css("background-color","#2980b9"),$("#fixed-menu").fadeIn(),$(".navbar-default").css("background-color","white")):($("#fixed-menu").css("background-color","rgba(0, 0, 0, 0.175)"),$("#fixed-menu").fadeOut())});try{$.ajax({type:"POST",url:"/getAllLocality",data:!1,async:!1,contentType:!1,processData:!1,success:processDataCheckLocality})}catch(t){console.log("exception occured!!"+t)}try{$.ajax({type:"POST",url:"/getAllJobs",data:!1,async:!1,contentType:!1,processData:!1,success:processDataCheckJobs})}catch(t){console.log("exception occured!!"+t)}try{$.ajax({type:"POST",url:"/getAllHotJobPosts",data:!1,async:!1,contentType:!1,processData:!1,success:processDataAllJobPosts})}catch(t){console.log("exception occured!!"+t)}});
