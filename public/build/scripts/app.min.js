...
function updateCallAttempts(e,t,n){if(null==e||null==t)return void console.log("invalid candidateId and jobPostId");NProgress.start();var o="/support/api/updatePreScreenAttempt/";$.ajax({type:"GET",url:o+"?candidateId="+e+"&jobPostId="+t+"&callStatus="+n,processData:!1,success:function(e){console.log("updateCallAttempt: "+e)}}),NProgress.done()}function saveAttempt(e,t){var n=$("#callResponse").val();updateCallAttempts(e,t,n),bootbox.hideAll()}function onCallYes(e,t){console.log("connected: "+e+" "+t),$("#callNoClass").hide(),$(".btn-success.btn-modal-submit").prop("disabled",!1),updateCallAttempts(e,t,"CONNECTED")}function onCallNo(e,t){$("#callNoClass").show()}function triggerPreScreenResponseSubmission(e,t){for(var n=$("#assessment_body input[type='checkbox']:checked"),o=[],a=n.size(),l=0;l<a;l++){var d=n[l],s=d.id.split("_"),c=s[1].split("-");if(c.length>1)for(var i=0;i<a;i++)o.push(c[i]);else o.push(s[1])}var p={candidateId:e,jobPostId:t,responseList:o};console.log(p)}function processPreScreenContent(e){if(console.log(e),null!=e){var t=e.candidateId,n=e.jobPostId,o=$('<div id="pre_screen_body"></div>'),a=$('<div class="row"></div>');o.append(a);var l=$('<div id="minReqTable"></div>');a.append("<h4>Min Requirement</h4>"),a.append(l);var d=$('<div id="otherReqTable"></div>');a.append("<h4>Other Requirement</h4>"),a.append(d);var s=document.createElement("table");s.className="mdl-data-table mdl-js-data-table mdl-shadow--2dp";var c=document.createElement("thead");s.appendChild(c);var i=document.createElement("tr");c.appendChild(i);var p=document.createElement("th");p.textContent="",i.appendChild(p);var r=document.createElement("th");r.textContent="Job Post",i.appendChild(r);var m=document.createElement("th");m.textContent="Candidate",i.appendChild(m);var u=document.createElement("th");u.textContent="Match?",i.appendChild(u);var h=document.createElement("th");h.textContent="Is candidate Ready",i.appendChild(h);var b=document.createElement("tbody");s.appendChild(b),l.append(s);var C=document.createElement("table");C.className="mdl-data-table mdl-js-data-table mdl-shadow--2dp";var c=document.createElement("thead");C.appendChild(c);var i=document.createElement("tr");c.appendChild(i);var p=document.createElement("th");p.textContent="",i.appendChild(p);var r=document.createElement("th");r.textContent="Job Post",i.appendChild(r);var m=document.createElement("th");m.textContent="Candidate",i.appendChild(m);var u=document.createElement("th");u.textContent="Match?",i.appendChild(u);var h=document.createElement("th");h.textContent="Is candidate Ready",i.appendChild(h);var v=document.createElement("tbody");C.appendChild(v),d.append(C);var E,y=e.elementList;null!=y&&"undefined"!=y&&(E=y.length),y.forEach(function(e){if(null!=e)if(e.isMinReq){var t=document.createElement("tr");t.id=e.propertyId,b.appendChild(t);var n=document.createElement("td");n.textContent=e.propertyTitle,t.appendChild(n);var o=document.createElement("td");t.appendChild(o);var a=document.createElement("td");t.appendChild(a),e.isSingleEntity?(a.textContent=e.candidateElement,o.textContent=e.jobPostElement):(a.textContent=e.candidateElementList,o.textContent=e.jobPostElementList);var l=document.createElement("td"),d=document.createElement("span");e.isMatching?d.setAttribute("class","glyphicon glyphicon-ok"):d.setAttribute("class","glyphicon glyphicon-remove"),l.appendChild(d),t.appendChild(l);var s=document.createElement("td");t.appendChild(s);var c=document.createElement("label");c.type="checkbox",c["for"]="checkbox_"+e.propertyId,c.style="text-align:center",c.className="mdl-checkbox mdl-js-checkbox mdl-js-ripple-effect",s.appendChild(c);var i=document.createElement("input");i.type="checkbox",i.id="checkbox_"+e.propertyId,i.className="mdl-checkbox__input",c.appendChild(i)}else{var t=document.createElement("tr");t.id=e.propertyId,v.appendChild(t);var n=document.createElement("td");n.textContent=e.propertyTitle,t.appendChild(n);var o=document.createElement("td");t.appendChild(o);var a=document.createElement("td");t.appendChild(a),e.isSingleEntity?(a.textContent=e.candidateElement,o.textContent=e.jobPostElement):(a.textContent=e.candidateElementList,o.textContent=e.jobPostElementList);var l=document.createElement("td"),d=document.createElement("span");e.isMatching?d.setAttribute("class","glyphicon glyphicon-ok"):d.setAttribute("class","glyphicon glyphicon-remove"),l.appendChild(d),t.appendChild(l);var s=document.createElement("td");t.appendChild(s);var c=document.createElement("label");c.type="checkbox",c["for"]="checkbox_"+e.propertyIdList.join("-"),c.style="text-align:center",c.className="mdl-checkbox mdl-js-checkbox mdl-js-ripple-effect",s.appendChild(c);var i=document.createElement("input");i.type="checkbox",i.id="checkbox_"+e.propertyIdList.join("-"),i.className="mdl-checkbox__input",c.appendChild(i)}});var g=$('<h4 id="callConfirmation">Call Connected? :&nbsp; <input type="radio" name="callConnected" id="callYes" value="yes" onclick="onCallYes('+t+", "+n+')">&nbsp;Yes&nbsp; <input type="radio" name="callConnected" id="callNo" value="no"  onclick="onCallNo('+t+", "+n+')">&nbsp;No <div id="callNoClass" style="display: none;"><h5>Reason?:<select id="callResponse" class="selectDropdown" style="margin: 0 8px;" ><option value="busy">Busy</option><option value="not_reachable">Not Reachable</option><option value="not_answering">Not Answering</option><option value="switched_off">Switched Off</option><option value="dnd">DND</option><option value="third_person">Third Person</option><option value="others">Others</option></select><button type="submit" id="responseSaveBtn"  class="btn btn-primary" onclick="saveAttempt('+t+", "+n+')">Save</button></h5></div></h4>');bootbox.dialog({className:"pre-screen-modal",title:g,message:o,closeButton:!0,animate:!0,onEscape:function(){$("body").removeClass("open-modal")},buttons:{Submit:{className:"btn-success btn-modal-submit",callback:function(){$("body").removeClass("open-modal"),$("#pre_screen_body input[type='checkbox']:checked").size()>0&&(console.log("final prescreen submission triggered"),triggerPreScreenResponseSubmission(t,n))}}},callback:function(e){console.log(e)}}),$(".btn-success.btn-modal-submit").prop("disabled",!0),$("body").removeClass("modal-open").removeClass("open-modal").addClass("open-modal")}}function processPostPreScreenResponse(e){return $("#customMsgIcon").attr("src","/assets/common/img/jobApplied.png"),$("#messagePromptModal").hasClass("in")?$("#customMsg").append(" & You have successfully completed assessment for this job."):$("#customMsg").html(" You have completed assessment for this job."),"ALL_ASSESSED"==e.status?(localStorage.setItem("assessed","1"),$(".assessmentStatus").removeClass("indicatorBtnRed").addClass("indicatorBtnGreen"),$(".assessmentStatus b font").text("Complete"),$("#assessmentDivRow a").attr("title","Completed !"),$("#messagePromptModal").modal("show"),null!=$("#ajp_"+e.jobRoleId)&&$("#ajp_"+e.jobRoleId).hide("slow",function(){$("#ajp_"+e.jobRoleId).remove()})):"OK"!=e&&"SUCCESS"!=e.status&&"ALREADY_ASSESSED"!=e.status||($("#jr_"+e.jobRoleId+" .assessmentStatus").removeClass("indicatorBtnRed").addClass("indicatorBtnGreen"),$("#jr_"+e.jobRoleId+" .assessmentStatus b font").text("Complete"),$("#tt_"+e.jobRoleId+"_ic").attr("title","Completed !"),$("#messagePromptModal").modal("show"),null!=$("#ajp_"+e.jobRoleId)&&$("#ajp_"+e.jobRoleId).hide("slow",function(){$("#ajp_"+e.jobRoleId).remove()})),e}function getPreScreenContent(e,t){var n="/support/api/getJobPostVsCandidate/";if(null==n||null==e)return void console.log("please provide candidateId && jobPostId");n+="?",null!=e&&(n+="jobPostId="+e),null!=t&&(n+="&candidateId="+t);try{$.ajax({type:"GET",url:n,data:!1,async:!1,contentType:!1,processData:!1,success:processPreScreenContent})}catch(o){console.log("exception occured!!"+o.stack)}}