...
function processDataModal(e){console.log("returedData :"+e.status),$("#addLeadFormModal").hide(),$("#thanksMsg").show(),$("#alreadyMsg").hide()}function processDataRecruiter(e){console.log("returedData :"+e.status),$("#form_recruiter").hide(),$("#thanksMsgRecruiter").show(),$("#errorMsgRecruiter").hide()}$(function(){$("#addLeadFormModal").submit(function(e){e.preventDefault();try{var a=$("#leadNameModal").val(),l=$("#leadMobileModal").val(),o=$("#leadChannelModal").val(),t=2,d=document.getElementById("interested").innerHTML;console.log("phone : "+l+" "+d);var r={leadName:a,leadMobile:l,leadChannel:o,leadType:t,leadInterest:d};$.ajax({type:"POST",url:"/addLead",data:r,success:processDataModal})}catch(n){console.log("exception occured!!"+n)}})}),$(function(){$("#form_recruiter").submit(function(e){e.preventDefault();try{var a=$("#leadName").val(),l=$("#leadMobile").val(),o=$("#leadChannel").val(),t=$("#leadType").val(),d=$("#leadInterest").val();console.log("phone: "+l);var r={leadName:a,leadMobile:l,leadChannel:o,leadType:t,leadInterest:d};$.ajax({type:"POST",url:"/addLead",data:r,success:processDataRecruiter})}catch(n){console.log("exception occured!!"+n)}})});
...
function processDataLogin(a){console.log("returedData :"+a.status+a.candidateName+a.accountStatus),1==a.status?(localStorage.setItem("mobile","+91"+candidateMobile),localStorage.setItem("name",a.candidateName),localStorage.setItem("id",a.candidateId),window.location="/dashboard"):3==a.status?($("#noUserLogin").show(),$("#incorrectMsgLogin").hide()):($("#noUserLogin").hide(),$("#incorrectMsgLogin").show())}var candidateMobile;$(function(){$("#form_login_candidate").submit(function(a){a.preventDefault();try{var o=$("#candidateLoginMobile").val(),e=$("#candidateLoginPassword").val();candidateMobile=o,console.log("phone: "+o);var t={candidateLoginMobile:o,candidateLoginPassword:e};$.ajax({type:"POST",url:"/loginSubmit",data:t,success:processDataLogin})}catch(n){console.log("exception occured!!"+n)}})});
function processDataResetCheckUser(e){console.log("returedData :"+e.status+" "+e.otp),1==e.status?(returnedOtp=e.otp,document.getElementById("helpText").innerHTML="Enter OTP sent on "+$("#resetPasswordMobile").val(),$("#form_password_reset_otp").show(),$("#form_forgot_password").hide(),$("#noUserLogin").hide()):(document.getElementById("resetCheckUserBtn").disabled=!1,$("#noUserLogin").show())}function processDataPostReset(e){console.log("returedData :"+e.status),1==e.status?(localStorage.setItem("mobile","+91"+candidateMobile),localStorage.setItem("name",e.candidateName),localStorage.setItem("id",e.candidateId),window.location="/dashboard"):2==e.status?(document.getElementById("resetNewPasswordBtn").disabled=!1,$("#incorrectMsg").show(),$("#errorMsg").hide()):(document.getElementById("resetNewPasswordBtn").disabled=!1,$("#incorrectMsg").hide(),$("#errorMsg").show())}var returnedOtp,candidateMobile;$(function(){$("#form_forgot_password").submit(function(e){e.preventDefault(),document.getElementById("resetCheckUserBtn").disabled=!0;try{var t=$("#resetPasswordMobile").val();candidateMobile=t;var s={resetPasswordMobile:t};$.ajax({type:"POST",url:"/findUserAndSendOtp",data:s,success:processDataResetCheckUser})}catch(o){console.log("exception occured!!"+o)}}),$("#form_password_reset_otp").submit(function(e){e.preventDefault();var t=$("#candidateForgotOtp").val();t==returnedOtp?($("#form_password_reset_otp").hide(),$("#form_password_reset_new").show(),$("#wrongOtp").hide()):$("#wrongOtp").show()}),$("#form_password_reset_new").submit(function(e){e.preventDefault(),document.getElementById("resetNewPasswordBtn").disabled=!0;try{var t=candidateMobile,s=$("#candidateNewPassword").val();console.log("phone: "+t);var o={candidatePassword:s,candidateAuthMobile:t};$.ajax({type:"POST",url:"/addPassword",data:o,success:processDataPostReset})}catch(a){console.log("exception occured!!"+a)}})});
function processDataSignUpSubmit(e){console.log("returedData :"+e.status),1==e.status?(returnedOtp=e.otp,$("#myRegistrationModal").modal("show"),$("#authMobile").val($("#candidateMobile").val()),$("#candidateName").val(""),$("#candidateSecondName").val(""),$("#candidateMobile").val(""),$("#candidateEmail").val(""),document.getElementById("helpTextSignUp").innerHTML="Enter OTP sent on "+candidateMobile,$("#form_otp").show()):3==e.status?(alert("User already exists! Please login to continue"),window.location="/"):($("#errorMsg").show(),$("#candidateName").val(""),$("#candidateMobile").val(""),$("#candidateEmail").val(""))}function processDataAddAuth(e){console.log("returedData :"+e.status),1==e.status?(localStorage.setItem("mobile","+91"+candidateMobile),localStorage.setItem("name",e.candidateName),localStorage.setItem("id",e.candidateId),console.log(e.candidateId),window.location="/dashboard"):$("#errorMsg").show()}var returnedOtp,candidateMobile;$(function(){$("#form_signup_candidate").submit(function(e){e.preventDefault();var a=$("#candidateLocality").val(),t=$("#candidateJobPref").val();if(""==a)alert("Please Enter your Job Localities");else if(""==t)alert("Please Enter the Jobs you are Interested");else{document.getElementById("registerBtn").disabled=!0;try{var d=$("#candidateName").val(),o=$("#candidateSecondName").val(),i=$("#candidateMobile").val();candidateMobile=i,$("#alreadyMsgCandidate").hide();var n={candidateName:d,candidateSecondName:o,candidateMobile:i,candidateLocality:$("#candidateLocality").val(),candidateJobPref:$("#candidateJobPref").val()};$.ajax({type:"POST",url:"/signUp",data:n,success:processDataSignUpSubmit})}catch(c){console.log("exception occured!!"+c)}}})}),$(function(){$("#form_otp").submit(function(e){e.preventDefault();var a=$("#candidateOtp").val();a==returnedOtp?($("#incorrectOtpMsg").hide(),$("#form_otp").hide(),$("#form_auth").show(),$("#errorMsg").hide(),$("#incorrectMsg").hide()):($("#incorrectOtpMsg").show(),$("#errorMsg").hide(),$("#candidateOtp").val(""))})}),$(function(){$("#form_auth").submit(function(e){e.preventDefault(),document.getElementById("btnSubmit").disabled=!0;try{var a=$("#candidatePassword").val(),t=candidateMobile,d={candidatePassword:a,candidateAuthMobile:t};console.log("userMobile: "+t),$.ajax({type:"POST",url:"/addPassword",data:d,success:processDataAddAuth})}catch(o){console.log("exception occured!!"+o)}})});
$(document).ready(function(){function e(e){var t=$(".preferredLocation")[0];e.forEach(function(e){var o=document.createElement("li");o.textContent=e.locality.localityName,t.appendChild(o);var a=e.localityId,n=e.locality.localityName,l={};l.id=a,l.name=n,s.push(l)})}function t(e){var t=$(".preferredJobs")[0];e.forEach(function(e){var o=document.createElement("li");o.textContent=e.jobRole.jobName,t.appendChild(o);var a=e.jobRole.jobRoleId,n=e.jobRole.jobName,l={};l.id=a,l.name=n,r.push(l)})}function o(e){e.forEach(function(e){var t=e.localityId,o=e.localityName,a={};a.id=t,a.name=o,c.push(a)})}function a(e){e.forEach(function(e){var t=e.jobId,o=e.jobName,a={};a.id=t,a.name=o,i.push(a)})}function n(){var e=localStorage.getItem("mobile");p.setQuery("select C where C="+e.substring(3,13)),p.send(l)}function l(e){if(!e.isError()){g=e.getDataTable(),new google.visualization.Table(document.getElementById("table")).draw(g,y);var t=document.getElementsByClassName("google-visualization-table-td google-visualization-table-td-number").length;t>0?($("#doneAssessment").show(),$("#takeAssessment").hide()):($("#doneAssessment").hide(),$("#takeAssessment").show())}}var c=[],s=[],i=[],r=[];try{$.ajax({type:"GET",url:"/getAllLocality",data:!1,contentType:!1,processData:!1,success:o})}catch(d){console.log("exception occured!!"+d)}try{$.ajax({type:"GET",url:"/getAllJobs",data:!1,contentType:!1,processData:!1,success:a})}catch(d){console.log("exception occured!!"+d)}try{$.ajax({type:"GET",url:"/getCandidateLocality/"+localStorage.getItem("id"),data:!1,contentType:!1,processData:!1,success:e})}catch(d){console.log("exception occured!!"+d)}try{$.ajax({type:"GET",url:"/getCandidateJob/"+localStorage.getItem("id"),data:!1,contentType:!1,processData:!1,success:t})}catch(d){console.log("exception occured!!"+d)}var u=localStorage.getItem("mobile"),m=localStorage.getItem("name");null!=u?(document.getElementById("helloMsg").innerHTML="Hello "+m+"!",document.getElementById("userName").innerHTML=m,document.getElementById("userMobile").innerHTML=u,$("#userExist").show(),$("#doneAssessment").hide(),$("#takeAssessment").hide()):(logoutUser(),window.location="/");var g,y={showRowNumber:!0},p=new google.visualization.Query("https://docs.google.com/spreadsheets/d/1HwEWPzZD4BFCyeRf5HO_KqNXyaMporxYQfg5lhOoA2g/edit#gid=496359801");google.setOnLoadCallback(n)});