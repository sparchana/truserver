...
function updateCallAttempts(e,t,n){if(null==e||null==t)return void console.log("invalid candidateId and jobPostId");NProgress.start();var a="/support/api/updatePreScreenAttempt/";$.ajax({type:"GET",url:a+"?candidateId="+e+"&jobPostId="+t+"&callStatus="+n,processData:!1,success:function(e){console.log("updateCallAttempt: "+e)}}),NProgress.done()}function saveAttempt(e,t){var n=$("#callResponse").val();updateCallAttempts(e,t,n),bootbox.hideAll()}function onCallYes(e,t){console.log("connected: "+e+" "+t),$("#callNoClass").hide(),$(".btn-success.btn-modal-submit").prop("disabled",!1),$("#pre_screen_body").show(),updateCallAttempts(e,t,"CONNECTED")}function onCallNo(e,t){$("#callNoClass").show(),$("#pre_screen_body").hide(),$(".btn-success.btn-modal-submit").prop("disabled",!0)}function triggerPreScreenResponseSubmission(e,t){for(var n=$("#pre_screen_body input[type='checkbox']:checked"),a=[],o=n.size(),d=0;d<o;d++){var l=n[d],c=l.id.split("_"),s=c[1].split("-"),r=s.length;if(s.length>1)for(var i=0;i<r;i++)a.push(parseInt(s[i]));else a.push(parseInt(c[1]))}var p={candidateId:e,jobPostId:t,preScreenIdList:a};try{$.ajax({type:"POST",url:"/submitPreScreen",contentType:"application/json; charset=utf-8",data:JSON.stringify(p),success:processPostPreScreenResponse})}catch(m){console.log("exception occured!!"+m)}}function processPreScreenContent(e){if(null!=e&&"SUCCESS"==e.status||(console.log(e),pushToSnackbar("Request failed. Something went Wrong! Please Refresh")),null!=e){var t=e.candidateId,n=e.jobPostId,a=$('<div id="pre_screen_body"></div>'),o=$('<div class="row" id="pre_screen_container_row"></div>');a.append(o);var d=$('<div id="minReqTable"></div>');o.append("<h4>Min Requirement</h4>"),o.append(d);var l=$('<div id="otherReqTable"></div>');o.append("<h4>Other Requirement</h4>"),o.append(l);var c=document.createElement("table");c.className="mdl-data-table mdl-js-data-table mdl-shadow--2dp";var s=document.createElement("thead");c.appendChild(s);var r=document.createElement("tr");s.appendChild(r);var i=document.createElement("th");i.textContent="",r.appendChild(i);var p=document.createElement("th");p.textContent="Job Post Info",r.appendChild(p);var m=document.createElement("th");m.textContent="Candidate Info",r.appendChild(m);var u=document.createElement("th");u.textContent="Match?",r.appendChild(u);var h=document.createElement("th");h.textContent="Is candidate Ready",r.appendChild(h);var b=document.createElement("tbody");c.appendChild(b),d.append(c);var C=document.createElement("table");C.className="mdl-data-table mdl-js-data-table mdl-shadow--2dp";var s=document.createElement("thead");C.appendChild(s);var r=document.createElement("tr");s.appendChild(r);var i=document.createElement("th");i.textContent="",r.appendChild(i);var p=document.createElement("th");p.textContent="Job Post",r.appendChild(p);var m=document.createElement("th");m.textContent="Candidate",r.appendChild(m);var u=document.createElement("th");u.textContent="Match?",r.appendChild(u);var h=document.createElement("th");h.textContent="Is candidate Ready",r.appendChild(h);var v=document.createElement("tbody");C.appendChild(v),l.append(C);var y=e.elementList;y.forEach(function(e){if(null!=e)if(e.isMinReq){var t=document.createElement("tr");t.id=e.propertyId,b.appendChild(t);var n=document.createElement("td");n.textContent=e.propertyTitle,t.appendChild(n);var a=document.createElement("td");t.appendChild(a);var o=document.createElement("td");t.appendChild(o),e.isSingleEntity?(o.textContent=e.candidateElement,a.textContent=e.jobPostElement):(o.textContent=e.candidateElementList,a.textContent=e.jobPostElementList);var d=document.createElement("td"),l=document.createElement("span");e.isMatching?l.setAttribute("class","glyphicon glyphicon-ok"):l.setAttribute("class","glyphicon glyphicon-remove"),d.appendChild(l),t.appendChild(d);var c=document.createElement("td");t.appendChild(c);var s=document.createElement("label");s.type="checkbox",s["for"]="checkbox_"+e.propertyIdList.join("-"),s.style="text-align:center",s.className="mdl-checkbox mdl-js-checkbox mdl-js-ripple-effect",c.appendChild(s);var r=document.createElement("input");r.type="checkbox",r.id="checkbox_"+e.propertyIdList.join("-"),r.className="mdl-checkbox__input",s.appendChild(r)}else{var t=document.createElement("tr");t.id=e.propertyId,v.appendChild(t);var n=document.createElement("td");n.textContent=e.propertyTitle,t.appendChild(n);var a=document.createElement("td");t.appendChild(a);var o=document.createElement("td");t.appendChild(o),e.isSingleEntity?(o.textContent=e.candidateElement,a.textContent=e.jobPostElement):(o.textContent=e.candidateElementList,a.textContent=e.jobPostElementList);var d=document.createElement("td"),l=document.createElement("span");e.isMatching?l.setAttribute("class","glyphicon glyphicon-ok"):l.setAttribute("class","glyphicon glyphicon-remove"),d.appendChild(l),t.appendChild(d);var c=document.createElement("td");t.appendChild(c);var s=document.createElement("label");s.type="checkbox",s["for"]="checkbox_"+e.propertyIdList.join("-"),s.style="text-align:center",s.className="mdl-checkbox mdl-js-checkbox mdl-js-ripple-effect",c.appendChild(s);var r=document.createElement("input");r.type="checkbox",r.id="checkbox_"+e.propertyIdList.join("-"),r.className="mdl-checkbox__input",s.appendChild(r)}});var E=$('<h4 id="callConfirmation">Call Connected? :&nbsp; <input type="radio" name="callConnected" id="callYes" value="yes" onclick="onCallYes('+t+", "+n+')">&nbsp;Yes&nbsp; <input type="radio" name="callConnected" id="callNo" value="no"  onclick="onCallNo('+t+", "+n+')">&nbsp;No <div id="callNoClass" style="display: none;"><h5>Reason?:<select id="callResponse" class="selectDropdown" style="margin: 0 8px;" ><option value="busy">Busy</option><option value="not_reachable">Not Reachable</option><option value="not_answering">Not Answering</option><option value="switched_off">Switched Off</option><option value="dnd">DND</option><option value="third_person">Third Person</option><option value="others">Others</option></select><button type="submit" id="responseSaveBtn"  class="btn btn-primary" onclick="saveAttempt('+t+", "+n+')">Save</button></h5></div></h4>');bootbox.dialog({className:"pre-screen-modal",title:E,message:a,closeButton:!0,animate:!0,onEscape:function(){$("body").removeClass("open-modal")},buttons:{Submit:{className:"btn-success btn-modal-submit",callback:function(){$("body").removeClass("open-modal"),$("#pre_screen_body input[type='checkbox']:checked").size()>0&&(console.log("final prescreen submission triggered"),triggerPreScreenResponseSubmission(t,n))}}},callback:function(e){console.log(e)}}),$(".btn-success.btn-modal-submit").prop("disabled",!0),$("#pre_screen_body").hide(),$("body").removeClass("modal-open").removeClass("open-modal").addClass("open-modal")}}function processPostPreScreenResponse(e){return console.log(e),e}function getPreScreenContent(e,t){var n="/support/api/getJobPostVsCandidate/";if(null==n||null==e)return void console.log("please provide candidateId && jobPostId");n+="?",null!=e&&(n+="jobPostId="+e),null!=t&&(n+="&candidateId="+t);try{$.ajax({type:"GET",url:n,data:!1,async:!1,contentType:!1,processData:!1,success:processPreScreenContent})}catch(a){console.log("exception occured!!"+a.stack)}}function pushToSnackbar(e){"use strict";var t=document.querySelector("#tru-snackbar"),n={message:JSON.stringify(e),timeout:4e3};t.MaterialSnackbar.showSnackbar(n)}