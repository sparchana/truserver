...
function processDataApplyJob(o){$("#messagePromptModal").modal("show"),1==o.status?(postToGoogle(),$("#customMsgIcon").attr("src","/assets/img/jobApplied.png"),$("#customMsg").html("Your Job Application is Successful")):2==o.status?($("#customMsgIcon").attr("src","/assets/img/jobApplied.png"),$("#customMsg").html("Oops! Something went Wrong. Unable to apply")):3==o.status?($("#customMsgIcon").attr("src","/assets/img/alreadyApplied.png"),$("#customMsg").html("Looks like you already applied for this Job. Click My Jobs to view your applied Jobs")):4==o.status?($("#customMsgIcon").attr("src","/assets/img/logo.gif"),$("#customMsg").html("Oops! Candidate does't Exists")):($("#customMsgIcon").attr("src","/assets/img/logo.gif"),$("#customMsg").html("Oops! Looks like the job is no longer available"))}function processDataAddJobPost(o){alert("Job Post added Successfully"),window.location="/support/addCompany"}function applyJob(o){applyJobFlag=1,applyJobId=o;var e=localStorage.getItem("mobile");if(null==e)openLogin(),$("#myLoginModal").modal("show"),$("#signInPopup").html("Sign In to Apply");else try{var a={jobId:o,candidateMobile:e};$.ajax({type:"POST",url:"/applyJob",async:!1,contentType:"application/json; charset=utf-8",data:JSON.stringify(a),success:processDataApplyJob})}catch(t){console.log("exception occured!!"+t)}}function processDataJobPostDetails(o){companyName=o.company.companyName,jobRoleName=o.jobPostTitle}function processDataGetCandidateInfo(o){try{$.ajax({type:"GET",url:"/getJobPostInfo/"+applyJobId,data:!1,async:!1,contentType:!1,processData:!1,success:processDataJobPostDetails})}catch(e){console.log("exception occured!!"+e)}if(console.log(o),candidateId=o.lead.leadId,candidateName=o.candidateFirstName+" "+o.candidateLastName,null!=o.candidateGender&&(candidateGender=0==o.candidateGender?"Male":"Female"),null!=o.candidateTotalExperience&&(totalExp=Math.round(parseInt(o.candidateTotalExperience)/12*100)/100),null!=o.candidateIsEmployed&&(isEmployed=0==o.candidateIsEmployed?"No":"Yes"),null!=o.candidateIsAssessed&&(isAssessed=0==o.candidateIsAssessed?"No":"Yes"),null!=o.languageKnownList||""!=o.languageKnownList){var a=o.languageKnownList;a.forEach(function(o){languagesKnown+=o.language.languageName+"("+o.readingAbility+","+o.writingAbility+","+o.verbalAbility+"), "})}console.log(languagesKnown),null!=o.motherTongue&&(motherTongue=o.motherTongue.languageName),null!=o.locality&&(homeLocality=o.locality),null!=o.candidateCurrentJobDetail&&(salary=o.candidateCurrentJobDetail.candidateCurrentSalary),null!=o.candidateEducation&&(education=o.candidateEducation.education.educationName);var t=o.jobPreferencesList;t.forEach(function(o){jobPref+=o.jobRole.jobName+", "});var s=o.localityPreferenceList;s.forEach(function(o){localityPref+=o.locality.localityName+", "});var n=o.candidateSkillList;n.forEach(function(o){candidateSkills+=o.skill.skillName+", "});try{$.ajax({url:"https://docs.google.com/forms/d/1NIGQC5jmSDuQaGUF0Jw1UG-Dz_3huFtZf9Bo7ncPl4g/formResponse",data:{"entry.1388755113":applyJobId,"entry.1115234203":companyName,"entry.1422779518":jobRoleName,"entry.942294281":candidateId,"entry.1345077393":candidateName,"entry.1859090779":localStorage.getItem("mobile"),"entry.2079461892":candidateGender,"entry.2071290015":totalExp,"entry.179139422":isEmployed,"entry.1488146275":isAssessed,"entry.67497584":languagesKnown,"entry.441069988":motherTongue,"entry.1350761294":homeLocality,"entry.2057814300":localityPref,"entry.598773915":jobPref,"entry.125850326":salary,"entry.240702722":education},type:"POST",dataType:"xml"})}catch(e){console.log("exception occured!!"+e)}}function postToGoogle(){try{$.ajax({type:"GET",url:"/getCandidateInfoDashboard",data:!1,async:!1,contentType:!1,processData:!1,success:processDataGetCandidateInfo})}catch(o){console.log("exception occured!!"+o)}}var companyName,jobRoleName,candidateId,candidateName,candidateGender,totalExp,isEmployed,isAssessed,languagesKnown="",candidateSkills="",jobPref="",localityPref="",salary,education,motherTongue,homeLocality;$(function(){$("#job_post_form").submit(function(o){o.preventDefault();var e=[],a=1,t=$("#jobPostLocalities").val().split(",");if(""==$("#jobPostCompany").val()?(alert("Please enter Job Post Company"),a=0):""==$("#jobPostTitle").val()?(alert("Please enter Job Post Title"),a=0):"0"==$("#jobPostMinSalary").val()?(alert("Please enter Job Post Minimum salary"),a=0):""==t?(alert("Please enter localities"),a=0):""==$("#jobPostExperience").val()&&(alert("Please enter Job Post Experience required"),a=0),1==a){var s;for(s=0;s<t.length;s++)e.push(parseInt(t[s]));var n=0,l=0;$("#jobPostIsHot").is(":checked")&&(n=1),$("#jobPostWorkFromHome").is(":checked")&&(l=1);var i=$("#jobPostMaxSalary").val();0!=i&&void 0!=i||(i=null);try{var c={jobPostMinSalary:$("#jobPostMinSalary").val(),jobPostMaxSalary:$("#jobPostMaxSalary").val(),jobPostStartTime:parseInt($("#jobPostStartTime").val()),jobPostEndTime:parseInt($("#jobPostEndTime").val()),jobPostIsHot:n,jobPostDescription:$("#jobPostDescription").val(),jobPostTitle:$("#jobPostTitle").val(),jobPostIncentives:$("#jobPostIncentives").val(),jobPostMinRequirement:$("#jobPostMinRequirement").val(),jobPostAddress:$("#jobPostAddress").val(),jobPostPinCode:$("#jobPostPinCode").val(),jobPostVacancies:$("#jobPostVacancies").val(),jobPostLocalities:e,jobPostJobRoleId:parseInt($("#jobPostJobRole").val()),jobPostCompanyId:$("#jobPostCompany").val(),jobPostDescriptionAudio:"",jobPostWorkFromHome:l,jobPostShiftId:$("#jobPostWorkShift").val(),jobPostEducationId:$("#jobPostEducation").val(),jobPostStatusId:$("#jobPostStatus").val(),pricingPlanTypeId:1,jobPostExperienceId:$("#jobPostExperience").val()};$.ajax({type:"POST",url:"/addJobPost",contentType:"application/json; charset=utf-8",data:JSON.stringify(c),success:processDataAddJobPost})}catch(r){console.log("exception occured!!"+r)}}})});
...
function getLocality(){return localityArray}function getJob(){return jobArray}function processDataCheckLocality(e){e.forEach(function(e){var t=e.localityId,a=e.localityName,o={};o.id=t,o.name=a,localityArray.push(o)})}function processDataCheckJobs(e){e.forEach(function(e){var t=e.jobRoleId,a=e.jobName,o={};o.id=t,o.name=a,jobArray.push(o)})}function processDataAllJobPosts(e){var t=0,a=Object.keys(e).length;if(a>0){var o=$("#hotJobPosts"),n=document.createElement("div");n.className="item active",o.append(n),e.forEach(function(e){if(t++,t>3)return!1;var a=document.createElement("div");a.className="col-lg-4",n.appendChild(a);var o=document.createElement("div");o.className="panel",o.id="hot_box",o.style="margin: 10%",a.appendChild(o);var c=document.createElement("div");c.className="panel-heading",c.id="hot_box_head",o.appendChild(c);var l=document.createElement("img");l.src="/assets/new/img/"+e.company.companyLogo+".png",c.appendChild(l);var d=document.createElement("div");d.className="panel-body",d.id="hot_box_body",o.appendChild(d);var s=document.createElement("div");s.className="hot_body_role",s.textContent=e.jobPostTitle,d.appendChild(s);var r=document.createElement("div");r.style="height: 1px; background: #0B4063",d.appendChild(r);var i=document.createElement("div");i.className="hot_body_salary","0"==e.jobPostMaxSalary?i.textContent="₹"+e.jobPostMinSalary+" monthly":i.textContent="₹"+e.jobPostMinSalary+" - ₹"+e.jobPostMaxSalary+" monthly",d.appendChild(i);var m=document.createElement("div");m.className="hot_body_salary",m.textContent="Experience: "+e.jobPostExperience.experienceType,d.appendChild(m);var p=document.createElement("div");p.style="height: 1px; background: #0B4063",d.appendChild(p);var h=document.createElement("div");h.className="hot_body_location";var v=e.jobPostToLocalityList,f="",u=0;v.forEach(function(e){if(u++,u>2)return!1;var t=e.locality.localityName;f+=t,u<Object.keys(v).length&&(f+=", ")}),v.length-2>0&&(f+=" more"),h.textContent=f,d.appendChild(h);var y=document.createElement("div");y.className="btn jobApplyBtn",y.id=e.jobPostId,y.onclick=function(){applyJob(e.jobPostId)},y.style="width: 100%; font-weight: bold",d.appendChild(y);var b=document.createElement("font");b.size="2",b.textContent="Apply",y.appendChild(b)});var c=a;if(a-=3,a>0){var l,d=Math.floor(a/3),s=3;for(l=0;d+1>l;l+=1)setJobs(e,s,c),s+=3}}}function setJobs(e,t,a){var o=$("#hotJobPosts"),n=document.createElement("div");n.className="item",o.append(n);var c=0;e.forEach(function(e){if(c++,c>t&&t+4>c&&a>=c){var o=document.createElement("div");o.className="col-lg-4",n.appendChild(o);var l=document.createElement("div");l.className="panel",l.id="hot_box",l.style="margin: 10%",o.appendChild(l);var d=document.createElement("div");d.className="panel-heading",d.id="hot_box_head",l.appendChild(d);var s=document.createElement("img");s.src="/assets/new/img/"+e.company.companyLogo+".png",d.appendChild(s);var r=document.createElement("div");r.className="panel-body",r.id="hot_box_body",l.appendChild(r);var i=document.createElement("div");i.className="hot_body_role",i.textContent=e.jobPostTitle,r.appendChild(i);var m=document.createElement("div");m.style="height: 1px; background: #0B4063",r.appendChild(m);var p=document.createElement("div");p.className="hot_body_salary","0"==e.jobPostMaxSalary?p.textContent="₹"+e.jobPostMinSalary+" monthly":p.textContent="₹"+e.jobPostMinSalary+" - ₹"+e.jobPostMaxSalary+" monthly",r.appendChild(p);var h=document.createElement("div");h.className="hot_body_salary",h.textContent="Experience: "+e.jobPostExperience.experienceType,r.appendChild(h);var v=document.createElement("div");v.style="height: 1px; background: #0B4063",r.appendChild(v);var f=document.createElement("div");f.className="hot_body_location";var u=e.jobPostToLocalityList,y="",b=0;u.forEach(function(e){if(b++,b>2)return!1;var t=e.locality.localityName;y+=t,b<Object.keys(u).length&&(y+=", ")}),u.length-2>0&&(y+=" more"),f.textContent=y,r.appendChild(f);var g=document.createElement("div");g.className="btn jobApplyBtn",g.id=e.jobPostId,g.onclick=function(){applyJob(e.jobPostId)},g.style="width: 100%; font-weight: bold",r.appendChild(g);var $=document.createElement("font");$.size="2",$.textContent="Apply",g.appendChild($)}})}function processCheckLeadStatus(){$("#addLeadMobile").val(""),$("#messagePromptModal").modal("show"),$("#customMsg").html("Thanks! We will get back soon!")}function addLead(){var e=$("#addLeadMobile").val(),t=validateMobile(e);if(0==t)alert("Enter a valid mobile number");else if(1==t)alert("Enter 10 digit mobile number");else try{var a={leadName:"",leadMobile:$("#addLeadMobile").val(),leadChannel:0,leadType:1,leadInterest:"General Registration"};$.ajax({type:"POST",url:"/addLead",contentType:"application/json; charset=utf-8",data:JSON.stringify(a),success:processCheckLeadStatus})}catch(o){console.log("exception occured!!"+o)}}function openLogin(){$("#signInPopup").html("Sign In"),document.getElementById("resetCheckUserBtn").disabled=!1,document.getElementById("resetNewPasswordBtn").disabled=!1,$("#form_login_candidate").show(),$("#noUserLogin").hide(),$("#incorrectMsgLogin").hide(),$("#form_forgot_password").hide(),$("#errorMsgReset").hide(),$("#form_password_reset_otp").hide(),$("#form_password_reset_new").hide()}function openSignUp(){$("#myLoginModal").modal("hide")}function resetPassword(){$("#noUserLogin").hide(),$("#incorrectMsgLogin").hide(),$("#form_login_candidate").hide(),$("#form_forgot_password").show()}var localityArray=[],jobArray=[];$(function(){$("#myRegistrationModal").on("hidden.bs.modal",function(){document.getElementById("registerBtn").disabled=!1,window.location="/"})}),$(document).ready(function(){localStorage.clear(),$(".navbar-nav li a").click(function(e){$(".navbar-collapse").collapse("hide")});var e=window.innerWidth;440>e&&$(".navbar-default").css("background-color","white"),$(window).scroll(function(){if($(document).scrollTop()>50){$("#fixed-menu").css("background-color","#2980b9");var e=window.innerWidth;if(e>440){$(".navbar-fixed-top").removeClass("fade-transparent").addClass("fade-background"),$("#navItem1").css("color","#747474"),$("#navItem2").css("color","#747474"),$("#navItem3").css("color","#747474"),$("#navItem4").css("color","#747474"),$("#navItem5").css("color","#747474");var t=document.getElementById("navLogo");t.src="/assets/new/img/logo-color.gif"}}else{$("#fixed-menu").css("background-color","rgba(0, 0, 0, 0.175)");var e=window.innerWidth;if(e>480){$(".navbar-fixed-top").removeClass("fade-background").addClass("fade-transparent"),$("#navItem1").css("color","#ffffff"),$("#navItem2").css("color","#ffffff"),$("#navItem3").css("color","#ffffff"),$("#navItem4").css("color","#ffffff"),$("#navItem5").css("color","#ffffff");var t=document.getElementById("navLogo");t.src="/assets/new/img/logo-main.gif";var e=window.innerWidth;480>e&&($("#fixed-menu").css("background-color","transparent"),$("#navItem1").css("color","#747474"),$("#navItem2").css("color","#747474"),$("#navItem3").css("color","#747474"),$("#navItem4").css("color","#747474"),$("#navItem5").css("color","#747474"))}}});try{$.ajax({type:"POST",url:"/getAllLocality",data:!1,async:!1,contentType:!1,processData:!1,success:processDataCheckLocality})}catch(t){console.log("exception occured!!"+t)}try{$.ajax({type:"POST",url:"/getAllJobs",data:!1,async:!1,contentType:!1,processData:!1,success:processDataCheckJobs})}catch(t){console.log("exception occured!!"+t)}try{$.ajax({type:"GET",url:"/getAllHotJobPosts",data:!1,async:!1,contentType:!1,processData:!1,success:processDataAllJobPosts})}catch(t){console.log("exception occured!!"+t)}});
