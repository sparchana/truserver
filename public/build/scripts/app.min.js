...
function processDataRecruiter(e){console.log("returedData :"+e.status),$("#form_recruiter").hide(),$("#thanksMsgRecruiter").show(),$("#errorMsgRecruiter").hide()}$(function(){$("#form_recruiter").submit(function(e){e.preventDefault();try{var a=$("#leadName").val(),t=$("#leadMobile").val(),r=$("#leadChannel").val(),l=$("#leadType").val(),o=$("#leadInterest").val();console.log("phone: "+t);var c={leadName:a,leadMobile:t,leadChannel:r,leadType:l,leadInterest:o};$.ajax({type:"POST",url:"/addLead",contentType:"application/json; charset=utf-8",data:JSON.stringify(c),success:processDataRecruiter})}catch(n){console.log("exception occured!!"+n)}})});
...
function processDataLogin(a){console.log(a),1==a.status?(localStorage.setItem("mobile","+91"+candidateMobile),localStorage.setItem("name",a.candidateName),localStorage.setItem("lastName",a.candidateLastName),localStorage.setItem("id",a.candidateId),localStorage.setItem("leadId",a.leadId),localStorage.setItem("assessed",a.isAssessed),window.location="/dashboard"):3==a.status?($("#noUserLogin").show(),$("#incorrectMsgLogin").hide()):($("#noUserLogin").hide(),$("#incorrectMsgLogin").show())}var candidateMobile;$(function(){$("#form_login_candidate").submit(function(a){a.preventDefault();try{var e=$("#candidateLoginMobile").val(),o=$("#candidateLoginPassword").val();candidateMobile=e,console.log("phone: "+e);var t={candidateLoginMobile:e,candidateLoginPassword:o};$.ajax({type:"POST",url:"/loginSubmit",contentType:"application/json; charset=utf-8",data:JSON.stringify(t),success:processDataLogin})}catch(i){console.log("exception occured!!"+i)}})});
function processDataResetCheckUser(e){console.log("returedData :"+e.status+" "+e.otp),1==e.status?(returnedOtp=e.otp,document.getElementById("helpText").innerHTML="Enter OTP sent on "+$("#resetPasswordMobile").val(),$("#form_password_reset_otp").show(),$("#form_forgot_password").hide(),$("#noUserLogin").hide()):(document.getElementById("resetCheckUserBtn").disabled=!1,$("#noUserLogin").show())}function processDataPostReset(e){console.log("returedData :"+e.status),1==e.status?(localStorage.setItem("mobile","+91"+candidateMobile),localStorage.setItem("name",e.candidateName),localStorage.setItem("lastName",e.candidateLastName),localStorage.setItem("id",e.candidateId),localStorage.setItem("leadId",e.leadId),localStorage.setItem("assessed",e.isAssessed),window.location="/dashboard"):2==e.status?(document.getElementById("resetNewPasswordBtn").disabled=!1,$("#incorrectMsg").show(),$("#errorMsg").hide()):(document.getElementById("resetNewPasswordBtn").disabled=!1,$("#incorrectMsg").hide(),$("#errorMsg").show())}var returnedOtp,candidateMobile;$(function(){$("#form_forgot_password").submit(function(e){e.preventDefault(),document.getElementById("resetCheckUserBtn").disabled=!0;try{var t=$("#resetPasswordMobile").val();candidateMobile=t;var s={resetPasswordMobile:t};$.ajax({type:"POST",url:"/findUserAndSendOtp",contentType:"application/json; charset=utf-8",data:JSON.stringify(s),success:processDataResetCheckUser})}catch(a){console.log("exception occured!!"+a)}}),$("#form_password_reset_otp").submit(function(e){e.preventDefault();var t=$("#candidateForgotOtp").val();t==returnedOtp?($("#form_password_reset_otp").hide(),$("#form_password_reset_new").show(),$("#wrongOtp").hide()):$("#wrongOtp").show()}),$("#form_password_reset_new").submit(function(e){if(e.preventDefault(),$("#candidateNewPassword").val().length<6)alert("Minimum 6 characters password required");else{document.getElementById("resetNewPasswordBtn").disabled=!0;try{var t=candidateMobile,s=$("#candidateNewPassword").val();console.log("phone: "+t);var a={candidatePassword:s,candidateAuthMobile:t};$.ajax({type:"POST",url:"/addPassword",contentType:"application/json; charset=utf-8",data:JSON.stringify(a),success:processDataPostReset})}catch(o){console.log("exception occured!!"+o)}}})});
function processDataSignUpSubmit(e){console.log("returedData :"+e.status),1==e.status?(returnedOtp=e.otp,$("#myRegistrationModal").modal("show"),$("#authMobile").val($("#candidateMobile").val()),$("#candidateName").val(""),$("#candidateSecondName").val(""),$("#candidateMobile").val(""),$("#candidateEmail").val(""),document.getElementById("helpTextSignUp").innerHTML="Enter OTP sent on "+candidateMobile,$("#form_otp").show()):3==e.status?(alert("User already exists! Please login to continue"),window.location="/"):($("#errorMsg").show(),$("#candidateName").val(""),$("#candidateMobile").val(""),$("#candidateEmail").val(""))}function processDataAddAuth(e){console.log("returedData :"+e.status),1==e.status?(localStorage.setItem("mobile","+91"+candidateMobile),localStorage.setItem("name",e.candidateName),localStorage.setItem("lastName",e.candidateLastName),localStorage.setItem("id",e.candidateId),localStorage.setItem("leadId",e.leadId),localStorage.setItem("assessed",e.isAssessed),console.log(e.candidateId),window.location="/dashboard"):$("#errorMsg").show()}var returnedOtp,candidateMobile;$(function(){$("#form_signup_candidate").submit(function(e){e.preventDefault();var a=$("#candidateLocality").val(),t=$("#candidateJobPref").val();if(""==a)alert("Please Enter your Job Localities");else if(""==t)alert("Please Enter the Jobs you are Interested");else{document.getElementById("registerBtn").disabled=!0;try{var d=$("#candidateName").val(),o=$("#candidateSecondName").val(),i=$("#candidateMobile").val();candidateMobile=i;var n,s=[],l=[],c=$("#candidateJobPref").val().split(","),r=$("#candidateLocality").val().split(",");for(n=0;n<c.length;n++)s.push(parseInt(c[n]));for(n=0;n<r.length;n++)l.push(parseInt(r[n]));$("#alreadyMsgCandidate").hide();var u={candidateName:d,candidateSecondName:o,candidateMobile:i,candidateLocality:l,candidateJobPref:s};$.ajax({type:"POST",url:"/signUp",contentType:"application/json; charset=utf-8",data:JSON.stringify(u),success:processDataSignUpSubmit})}catch(m){console.log("exception occured!!"+m)}}})}),$(function(){$("#form_otp").submit(function(e){e.preventDefault();var a=$("#candidateOtp").val();a==returnedOtp?($("#incorrectOtpMsg").hide(),$("#form_otp").hide(),$("#form_auth").show(),$("#errorMsg").hide(),$("#incorrectMsg").hide()):($("#incorrectOtpMsg").show(),$("#errorMsg").hide(),$("#candidateOtp").val(""))})}),$(function(){$("#form_auth").submit(function(e){if(e.preventDefault(),$("#candidatePassword").val().length<6)alert("Minimum 6 characters password required");else{document.getElementById("btnSubmit").disabled=!0;try{var a=$("#candidatePassword").val(),t=candidateMobile,d={candidatePassword:a,candidateAuthMobile:t};console.log("userMobile: "+t),$.ajax({type:"POST",url:"/addPassword",contentType:"application/json; charset=utf-8",data:JSON.stringify(d),success:processDataAddAuth})}catch(o){console.log("exception occured!!"+o)}}})});